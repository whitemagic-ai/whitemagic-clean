...
static inline kk_std_time_time__time kk_std_time_time__create_Time(kk_std_time_date__date date, kk_std_time_date__clock clock, kk_std_time_calendar__calendar calendar, kk_std_core_types__optional tzdelta, kk_std_core_types__optional tzabbrv, kk_std_core_types__optional timezone, kk_std_time_instant__instant instant, kk_context_t* _ctx) { /* (date : std/time/date/date, clock : std/time/date/clock, calendar : std/time/calendar/calendar, tzdelta : ? std/time/duration/duration, tzabbrv : ? string, timezone : ? std/time/calendar/timezone, instant : std/time/instant/instant) -> time */ 
  kk_std_time_duration__duration _x_x1042;
  if (kk_std_core_types__is_Optional(tzdelta, _ctx)) {
    ...
    _x_x1042 = _uniq_tzdelta_200; /*std/time/duration/duration*/
  }
  else {
    kk_std_core_types__optional_drop(tzdelta, _ctx);
    _x_x1042 = kk_std_time_duration_zero; /*std/time/duration/duration*/
  }
  ...
  if (kk_std_core_types__is_Optional(tzabbrv, _ctx)) {
    ...
    _x_x1043 = _uniq_tzabbrv_204; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(tzabbrv, _ctx);
    _x_x1043 = kk_string_empty(); /*string*/
  }
  kk_std_time_calendar__timezone _x_x1045;
  if (kk_std_core_types__is_Optional(timezone, _ctx)) {
    ...
    _x_x1045 = _uniq_timezone_208; /*std/time/calendar/timezone*/
  }
  else {
    kk_std_core_types__optional_drop(timezone, _ctx);
    _x_x1045 = kk_std_time_calendar__timezone_dup(kk_std_time_calendar_tz_utc, _ctx); /*std/time/calendar/timezone*/
  }
  return kk_std_time_time__new_Time(kk_reuse_null, 0, date, clock, calendar, _x_x1042, _x_x1043, _x_x1045, instant, _ctx);
}
...
static inline kk_std_time_date__date kk_std_time_time_time_fs_date(kk_std_time_time__time time_0, kk_context_t* _ctx) { /* (time : time) -> std/time/date/date */ 
  {
    struct kk_std_time_time_Time* _con_x1046 = kk_std_time_time__as_Time(time_0, _ctx);
    kk_std_time_date__date _x = _con_x1046->date;
    kk_std_time_date__clock _pat_3 = _con_x1046->clock;
    kk_std_time_calendar__calendar _pat_7 = _con_x1046->calendar;
    kk_std_time_duration__duration _pat_16 = _con_x1046->tzdelta;
    kk_std_time_calendar__timezone _pat_19 = _con_x1046->timezone;
    kk_std_time_instant__instant _pat_23 = _con_x1046->instant;
    struct kk_std_time_date_Clock* _con_x1047 = kk_std_time_date__as_Clock(_pat_3, _ctx);
    struct kk_std_time_calendar_Calendar* _con_x1048 = kk_std_time_calendar__as_Calendar(_pat_7, _ctx);
    struct kk_std_time_calendar_Timezone* _con_x1049 = kk_std_time_calendar__as_Timezone(_pat_19, _ctx);
...
static inline kk_std_time_date__clock kk_std_time_time_time_fs_clock(kk_std_time_time__time time_0, kk_context_t* _ctx) { /* (time : time) -> std/time/date/clock */ 
  {
    struct kk_std_time_time_Time* _con_x1050 = kk_std_time_time__as_Time(time_0, _ctx);
    kk_std_time_date__date _pat_0 = _con_x1050->date;
    kk_std_time_date__clock _x = _con_x1050->clock;
    kk_std_time_calendar__calendar _pat_7 = _con_x1050->calendar;
    kk_std_time_duration__duration _pat_16 = _con_x1050->tzdelta;
    kk_std_time_calendar__timezone _pat_19 = _con_x1050->timezone;
    kk_std_time_instant__instant _pat_23 = _con_x1050->instant;
    struct kk_std_time_date_Clock* _con_x1051 = kk_std_time_date__as_Clock(_x, _ctx);
    struct kk_std_time_calendar_Calendar* _con_x1052 = kk_std_time_calendar__as_Calendar(_pat_7, _ctx);
    struct kk_std_time_calendar_Timezone* _con_x1053 = kk_std_time_calendar__as_Timezone(_pat_19, _ctx);
...
static inline kk_std_time_calendar__calendar kk_std_time_time_time_fs_calendar(kk_std_time_time__time time_0, kk_context_t* _ctx) { /* (time : time) -> std/time/calendar/calendar */ 
  {
    struct kk_std_time_time_Time* _con_x1054 = kk_std_time_time__as_Time(time_0, _ctx);
    kk_std_time_date__date _pat_0 = _con_x1054->date;
    kk_std_time_date__clock _pat_4 = _con_x1054->clock;
    kk_std_time_calendar__calendar _x = _con_x1054->calendar;
    kk_std_time_duration__duration _pat_16 = _con_x1054->tzdelta;
    kk_std_time_calendar__timezone _pat_19 = _con_x1054->timezone;
    kk_std_time_instant__instant _pat_23 = _con_x1054->instant;
    struct kk_std_time_date_Clock* _con_x1055 = kk_std_time_date__as_Clock(_pat_4, _ctx);
    struct kk_std_time_calendar_Calendar* _con_x1056 = kk_std_time_calendar__as_Calendar(_x, _ctx);
    struct kk_std_time_calendar_Timezone* _con_x1057 = kk_std_time_calendar__as_Timezone(_pat_19, _ctx);
...
static inline kk_std_time_duration__duration kk_std_time_time_time_fs_tzdelta(kk_std_time_time__time time_0, kk_context_t* _ctx) { /* (time : time) -> std/time/duration/duration */ 
  {
    struct kk_std_time_time_Time* _con_x1058 = kk_std_time_time__as_Time(time_0, _ctx);
    kk_std_time_date__date _pat_0 = _con_x1058->date;
    kk_std_time_date__clock _pat_4 = _con_x1058->clock;
    kk_std_time_calendar__calendar _pat_8 = _con_x1058->calendar;
    kk_std_time_duration__duration _x = _con_x1058->tzdelta;
    kk_std_time_calendar__timezone _pat_19 = _con_x1058->timezone;
    kk_std_time_instant__instant _pat_23 = _con_x1058->instant;
    struct kk_std_time_date_Clock* _con_x1059 = kk_std_time_date__as_Clock(_pat_4, _ctx);
    struct kk_std_time_calendar_Calendar* _con_x1060 = kk_std_time_calendar__as_Calendar(_pat_8, _ctx);
    struct kk_std_time_calendar_Timezone* _con_x1061 = kk_std_time_calendar__as_Timezone(_pat_19, _ctx);
    return _x;
  }
}
...
static inline kk_string_t kk_std_time_time_time_fs_tzabbrv(kk_std_time_time__time time_0, kk_context_t* _ctx) { /* (time : time) -> string */ 
  {
    struct kk_std_time_time_Time* _con_x1062 = kk_std_time_time__as_Time(time_0, _ctx);
    kk_std_time_date__date _pat_0 = _con_x1062->date;
    kk_std_time_date__clock _pat_4 = _con_x1062->clock;
    kk_std_time_calendar__calendar _pat_8 = _con_x1062->calendar;
    kk_std_time_duration__duration _pat_17 = _con_x1062->tzdelta;
    kk_std_time_calendar__timezone _pat_19 = _con_x1062->timezone;
    kk_std_time_instant__instant _pat_23 = _con_x1062->instant;
    struct kk_std_time_date_Clock* _con_x1063 = kk_std_time_date__as_Clock(_pat_4, _ctx);
    struct kk_std_time_calendar_Calendar* _con_x1064 = kk_std_time_calendar__as_Calendar(_pat_8, _ctx);
    struct kk_std_time_calendar_Timezone* _con_x1065 = kk_std_time_calendar__as_Timezone(_pat_19, _ctx);
    kk_string_t _x = _con_x1062->tzabbrv;
...
static inline kk_std_time_calendar__timezone kk_std_time_time_time_fs_timezone(kk_std_time_time__time time_0, kk_context_t* _ctx) { /* (time : time) -> std/time/calendar/timezone */ 
  {
    struct kk_std_time_time_Time* _con_x1066 = kk_std_time_time__as_Time(time_0, _ctx);
    kk_std_time_date__date _pat_0 = _con_x1066->date;
    kk_std_time_date__clock _pat_4 = _con_x1066->clock;
    kk_std_time_calendar__calendar _pat_8 = _con_x1066->calendar;
    kk_std_time_duration__duration _pat_17 = _con_x1066->tzdelta;
    kk_std_time_calendar__timezone _x = _con_x1066->timezone;
    kk_std_time_instant__instant _pat_23 = _con_x1066->instant;
    struct kk_std_time_date_Clock* _con_x1067 = kk_std_time_date__as_Clock(_pat_4, _ctx);
    struct kk_std_time_calendar_Calendar* _con_x1068 = kk_std_time_calendar__as_Calendar(_pat_8, _ctx);
    struct kk_std_time_calendar_Timezone* _con_x1069 = kk_std_time_calendar__as_Timezone(_x, _ctx);
...
static inline kk_std_time_instant__instant kk_std_time_time_time_fs_instant(kk_std_time_time__time time_0, kk_context_t* _ctx) { /* (time : time) -> std/time/instant/instant */ 
  {
    struct kk_std_time_time_Time* _con_x1070 = kk_std_time_time__as_Time(time_0, _ctx);
    kk_std_time_date__date _pat_0 = _con_x1070->date;
    kk_std_time_date__clock _pat_4 = _con_x1070->clock;
    kk_std_time_calendar__calendar _pat_8 = _con_x1070->calendar;
    kk_std_time_duration__duration _pat_17 = _con_x1070->tzdelta;
    kk_std_time_calendar__timezone _pat_20 = _con_x1070->timezone;
    kk_std_time_instant__instant _x = _con_x1070->instant;
    struct kk_std_time_date_Clock* _con_x1071 = kk_std_time_date__as_Clock(_pat_4, _ctx);
    struct kk_std_time_calendar_Calendar* _con_x1072 = kk_std_time_calendar__as_Calendar(_pat_8, _ctx);
    struct kk_std_time_calendar_Timezone* _con_x1073 = kk_std_time_calendar__as_Timezone(_pat_20, _ctx);
...
static inline kk_std_time_time__time kk_std_time_time_add_months(kk_std_time_time__time t, kk_integer_t months, kk_context_t* _ctx) { /* (t : time, months : int) -> time */ 
  kk_std_time_date__date _x_x1947 = kk_std_time_date__new_Date(kk_integer_from_small(0), months, kk_integer_from_small(0), _ctx); /*std/time/date/date*/
  return kk_std_time_time_add_date(t, _x_x1947, kk_std_core_types__new_None(_ctx), _ctx);
}
 
// Add  a specified number of years to a calendar time.

static inline kk_std_time_time__time kk_std_time_time_add_years(kk_std_time_time__time t, kk_integer_t years, kk_context_t* _ctx) { /* (t : time, years : int) -> time */ 
  kk_std_time_date__date _x_x1948 = kk_std_time_date__new_Date(years, kk_integer_from_small(0), kk_integer_from_small(0), _ctx); /*std/time/date/date*/
  return kk_std_time_time_add_date(t, _x_x1948, kk_std_core_types__new_None(_ctx), _ctx);
}
...
static inline kk_std_time_time__time kk_std_time_time_first_weekday(kk_std_time_time__time t, kk_std_time_date__weekday wd, kk_context_t* _ctx) { /* (t : time, wd : std/time/date/weekday) -> time */ 
  return kk_std_time_time_nth_weekday(t, kk_integer_from_small(1), wd, _ctx);
}
 
// Return the last week day before time `t`.
// `time(2016,11,1).last-weekday(Sun)` &quad;  (2016-10-30, Last Sunday of October 2016)

static inline kk_std_time_time__time kk_std_time_time_last_weekday(kk_std_time_time__time t, kk_std_time_date__weekday wd, kk_context_t* _ctx) { /* (t : time, wd : std/time/date/weekday) -> time */ 
  return kk_std_time_time_nth_weekday(t, kk_integer_from_small(0), wd, _ctx);
}
