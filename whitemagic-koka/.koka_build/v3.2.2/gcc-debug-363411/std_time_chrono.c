...
kk_std_time_instant__instant kk_std_time_chrono_now_in(kk_std_core_types__optional ts, kk_context_t* _ctx) { /* (ts : ? std/time/instant/timescale) -> ndet std/time/instant/instant */ 
  kk_std_core_types__tuple2 _match_x33 = kk_std_time_chrono_unix_now(_ctx); /*(float64, float64)*/;
  {
    ...
    kk_std_num_ddouble__ddouble _x_x36;
    bool _match_x34 = (frac == (0x0p+0)); /*bool*/;
    if (_match_x34) {
      _x_x36 = kk_std_num_ddouble__new_Ddouble(secs, 0x0p+0, _ctx); /*std/num/ddouble/ddouble*/
    }
    else {
      _x_x36 = kk_std_num_ddouble_dsum(secs, frac, _ctx); /*std/num/ddouble/ddouble*/
    }
    kk_std_core_types__optional _x_x37 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 7*/
    kk_std_core_types__optional _x_x38;
    kk_box_t _x_x39;
    kk_std_time_instant__timescale _x_x40;
    if (kk_std_core_types__is_Optional(ts, _ctx)) {
      ...
      _x_x40 = _uniq_ts_34; /*std/time/instant/timescale*/
    }
    else {
      kk_std_core_types__optional_drop(ts, _ctx);
      _x_x40 = kk_std_time_instant__timescale_dup(kk_std_time_utc_ts_ti, _ctx); /*std/time/instant/timescale*/
    }
    _x_x39 = kk_std_time_instant__timescale_box(_x_x40, _ctx); /*7*/
    _x_x38 = kk_std_core_types__new_Optional(_x_x39, _ctx); /*? 7*/
    return kk_std_time_utc_timespan_fs_unix_instant(_x_x36, _x_x37, _x_x38, _ctx);
  }
}
...
struct kk_std_time_chrono__mlift_now_10006_fun42__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_time_chrono__mlift_now_10006_fun42(kk_function_t _fself, kk_box_t _b_x10, kk_context_t* _ctx);
static kk_function_t kk_std_time_chrono__new_mlift_now_10006_fun42(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_time_chrono__mlift_now_10006_fun42, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}

static kk_box_t kk_std_time_chrono__mlift_now_10006_fun42(kk_function_t _fself, kk_box_t _b_x10, kk_context_t* _ctx) {
  kk_function_static_drop(_fself,kk_context());
  kk_std_time_instant__instant _x_x43;
  kk_std_core_types__optional _x_x44 = kk_std_core_types__optional_unbox(_b_x10, KK_OWNED, _ctx); /*? std/time/instant/timescale*/
  _x_x43 = kk_std_time_chrono_now_in(_x_x44, _ctx); /*std/time/instant/instant*/
  return kk_std_time_instant__instant_box(_x_x43, _ctx);
}
...
kk_std_time_instant__instant kk_std_time_chrono__mlift_now_10006(kk_std_time_instant__timescale _y_x10003, kk_context_t* _ctx) { /* (std/time/instant/timescale) -> std/time/utc/utc std/time/instant/instant */ 
  kk_box_t _x_x41;
  kk_box_t _x_x45;
  kk_std_core_types__optional _x_x46 = kk_std_core_types__new_Optional(kk_std_time_instant__timescale_box(_y_x10003, _ctx), _ctx); /*? 7*/
  _x_x45 = kk_std_core_types__optional_box(_x_x46, _ctx); /*9903*/
  _x_x41 = kk_std_core_hnd__open_none1(kk_std_time_chrono__new_mlift_now_10006_fun42(_ctx), _x_x45, _ctx); /*9904*/
  return kk_std_time_instant__instant_unbox(_x_x41, KK_OWNED, _ctx);
}
...
// lift anonymous function
struct kk_std_time_chrono_now_fun50__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_time_chrono_now_fun50(kk_function_t _fself, kk_box_t _b_x21, kk_context_t* _ctx);
static kk_function_t kk_std_time_chrono_new_now_fun50(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_time_chrono_now_fun50, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}

static kk_box_t kk_std_time_chrono_now_fun50(kk_function_t _fself, kk_box_t _b_x21, kk_context_t* _ctx) {
  kk_function_static_drop(_fself,kk_context());
  kk_std_time_instant__instant _x_x51;
  kk_std_time_instant__timescale _x_x52 = kk_std_time_instant__timescale_unbox(_b_x21, KK_OWNED, _ctx); /*std/time/instant/timescale*/
  _x_x51 = kk_std_time_chrono__mlift_now_10006(_x_x52, _ctx); /*std/time/instant/instant*/
  return kk_std_time_instant__instant_box(_x_x51, _ctx);
}


// lift anonymous function
struct kk_std_time_chrono_now_fun53__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_time_chrono_now_fun53(kk_function_t _fself, kk_box_t _b_x25, kk_context_t* _ctx);
static kk_function_t kk_std_time_chrono_new_now_fun53(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_time_chrono_now_fun53, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}

static kk_box_t kk_std_time_chrono_now_fun53(kk_function_t _fself, kk_box_t _b_x25, kk_context_t* _ctx) {
  kk_function_static_drop(_fself,kk_context());
  kk_std_time_instant__instant _x_x54;
  kk_std_core_types__optional _x_x55 = kk_std_core_types__optional_unbox(_b_x25, KK_OWNED, _ctx); /*? std/time/instant/timescale*/
  _x_x54 = kk_std_time_chrono_now_in(_x_x55, _ctx); /*std/time/instant/instant*/
  return kk_std_time_instant__instant_box(_x_x54, _ctx);
}
...
kk_std_time_instant__instant kk_std_time_chrono_now(kk_context_t* _ctx) { /* () -> <ndet,std/time/utc/utc> std/time/instant/instant */ 
  ...
  kk_box_t _x_x47;
  {
    struct kk_std_core_hnd_Ev* _con_x48 = kk_std_core_hnd__as_Ev(ev_10010, _ctx);
    kk_box_t _box_x14 = _con_x48->hnd;
    int32_t m = _con_x48->marker;
    ...
    _match_x31 = _brw_x32; /*hnd/clause0<std/time/instant/timescale,std/time/utc/utc,213,214>*/
    {
      ...
      _x_x47 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_context_t*), _fun_unbox_x17, (_fun_unbox_x17, m, ev_10010, _ctx), _ctx); /*35*/
    }
  }
  x_10007 = kk_std_time_instant__timescale_unbox(_x_x47, KK_OWNED, _ctx); /*std/time/instant/timescale*/
  kk_box_t _x_x49;
  if (kk_yielding(kk_context())) {
    kk_datatype_ptr_dropn(x_10007, (KK_I32(10)), _ctx);
    _x_x49 = kk_std_core_hnd_yield_extend(kk_std_time_chrono_new_now_fun50(_ctx), _ctx); /*2419*/
  }
  else {
    kk_box_t _x_x56;
    kk_std_core_types__optional _x_x57 = kk_std_core_types__new_Optional(kk_std_time_instant__timescale_box(x_10007, _ctx), _ctx); /*? 7*/
    _x_x56 = kk_std_core_types__optional_box(_x_x57, _ctx); /*9903*/
    _x_x49 = kk_std_core_hnd__open_none1(kk_std_time_chrono_new_now_fun53(_ctx), _x_x56, _ctx); /*2419*/
  }
  return kk_std_time_instant__instant_unbox(_x_x49, KK_OWNED, _ctx);
}
