...
extern kk_unit_t kk_src_unified__runtime__v2__main__main_fun3(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_string_t _x_x4;
  kk_define_string_literal(, _s_x5, 94, "{\"status\":\"started\",\"unified_runtime\":true,\"version\":\"2.0\",\"imports\":[\"gan_ying\",\"hot_paths\"]}", _ctx)
  _x_x4 = kk_string_dup(_s_x5, _ctx); /*string*/
  kk_std_core_console_printsln(_x_x4, _ctx);
  kk_src_unified__runtime__v2__unified_state _x_x6 = kk_src_unified__runtime__v2__new_Unified_state(kk_reuse_null, 0, kk_std_core_types__new_Nil(_ctx), kk_std_core_types__new_Nil(_ctx), kk_integer_from_small(0), 0x0p+0, _ctx); /*src/unified_runtime_v2/unified-state*/
  kk_src_unified__runtime__v2_server_loop(_x_x6, _ctx); return kk_Unit;
}
