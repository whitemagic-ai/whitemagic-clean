...
static inline kk_std_core_types__list kk_src_unified__runtime__v2_unified_state_fs_events(kk_src_unified__runtime__v2__unified_state _this, kk_context_t* _ctx) { /* (unified-state) -> list<gan_ying/resonance-event> */ 
  {
    struct kk_src_unified__runtime__v2_Unified_state* _con_x372 = kk_src_unified__runtime__v2__as_Unified_state(_this, _ctx);
    kk_std_core_types__list _x = _con_x372->events;
...
static inline kk_std_core_types__list kk_src_unified__runtime__v2_unified_state_fs_profiles(kk_src_unified__runtime__v2__unified_state _this, kk_context_t* _ctx) { /* (unified-state) -> list<hot_paths/path-profile> */ 
  {
    struct kk_src_unified__runtime__v2_Unified_state* _con_x373 = kk_src_unified__runtime__v2__as_Unified_state(_this, _ctx);
    kk_std_core_types__list _x = _con_x373->profiles;
    return kk_std_core_types__list_dup(_x, _ctx);
  }
}
...
static inline kk_integer_t kk_src_unified__runtime__v2_unified_state_fs_total_ops(kk_src_unified__runtime__v2__unified_state _this, kk_context_t* _ctx) { /* (unified-state) -> int */ 
  {
    struct kk_src_unified__runtime__v2_Unified_state* _con_x374 = kk_src_unified__runtime__v2__as_Unified_state(_this, _ctx);
    kk_integer_t _x = _con_x374->total_ops;
...
static inline double kk_src_unified__runtime__v2_unified_state_fs_session_start(kk_src_unified__runtime__v2__unified_state _this, kk_context_t* _ctx) { /* (unified-state) -> float64 */ 
  {
    struct kk_src_unified__runtime__v2_Unified_state* _con_x375 = kk_src_unified__runtime__v2__as_Unified_state(_this, _ctx);
    double _x = _con_x375->session_start;
    return _x;
  }
}
...
static inline kk_unit_t kk_src_unified__runtime__v2_main(kk_context_t* _ctx) { /* () -> io () */ 
  ...
  kk_string_t _x_x874;
  kk_define_string_literal(, _s_x875, 94, "{\"status\":\"started\",\"unified_runtime\":true,\"version\":\"2.0\",\"imports\":[\"gan_ying\",\"hot_paths\"]}", _ctx)
  _x_x874 = kk_string_dup(_s_x875, _ctx); /*string*/
  kk_std_core_console_printsln(_x_x874, _ctx);
  kk_src_unified__runtime__v2__unified_state _x_x876 = kk_src_unified__runtime__v2__new_Unified_state(kk_reuse_null, 0, kk_std_core_types__new_Nil(_ctx), kk_std_core_types__new_Nil(_ctx), kk_integer_from_small(0), 0x0p+0, _ctx); /*src/unified_runtime_v2/unified-state*/
  kk_src_unified__runtime__v2_server_loop(_x_x876, _ctx); return kk_Unit;
}
