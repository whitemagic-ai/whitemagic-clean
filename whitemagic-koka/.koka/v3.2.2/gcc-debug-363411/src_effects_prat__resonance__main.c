...
#include "src_effects_prat__resonance__main.h"
...
void kk_src_effects_prat__resonance__main__init(kk_context_t* _ctx){
  ...
  kk_src_effects_prat__resonance__init(_ctx);
...
void kk_src_effects_prat__resonance__main__done(kk_context_t* _ctx){
  ...
  _kk_done = true;
    ...
    KK_CUSTOM_DONE (_ctx);
  #endif
  kk_src_effects_prat__resonance__done(_ctx);
...
void main_init(kk_context_t* _ctx) {
  kk_src_effects_prat__resonance__main__init(_ctx);
}
void main_run(kk_context_t* _ctx) {
  kk_src_effects_prat__resonance__main__main(_ctx);
}
void main_done(kk_context_t* _ctx) {
  kk_src_effects_prat__resonance__main__done(_ctx);
}
