...
kk_string_t kk_std_os_readline_readline(kk_context_t* _ctx) { /* () -> <console/console,exn> string */ 
  ...
  kk_box_t _x_x22 = kk_std_core_hnd__open_none0(kk_std_os_readline_new_readline_fun23(_ctx), _ctx); /*10000*/
  ...
  if (kk_std_core_exn__is_Error(_match_x15, _ctx)) {
    ...
    _x_x35 = kk_string_box(_x_x36); /*10001*/
    _x_x26 = kk_std_core_hnd__open_none2(kk_std_os_readline_new_readline_fun27(_ctx), kk_std_core_exn__exception_box(exn, _ctx), _x_x35, _ctx); /*10002*/
    ...
    kk_box_t _x_x38 = kk_std_core_exn_untry(_b_x6_9, _ctx); /*10000*/
