...
static inline kk_std_core_hnd__htag kk_std_core_hnd_ev_fs_htag(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> htag<a> */ 
  {
    struct kk_std_core_hnd_Ev* _con_x306 = kk_std_core_hnd__as_Ev(ev, _ctx);
    kk_std_core_hnd__htag _x = _con_x306->htag;
...
static inline kk_box_t kk_std_core_hnd_local_var(kk_box_t init, kk_function_t action, kk_context_t* _ctx) { /* forall<a,b,e,h> (init : a, action : (local-var<h,a>) -> <local<h>|e> b) -> <local<h>|e> b */ 
  ...
  kk_box_t res;
  kk_ref_t _x_x350 = kk_ref_dup(loc, _ctx); /*local-var<4257,4254>*/
  res = kk_function_call(kk_box_t, (kk_function_t, kk_ref_t, kk_context_t*), action, (action, _x_x350, _ctx), _ctx); /*4255*/
...
static inline kk_box_t kk_std_core_hnd_finally(kk_function_t fin, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (fin : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x_x354 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*4424*/
  return kk_std_core_hnd_finally_prompt(fin, _x_x354, _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_resume(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e b */ 
  {
    ...
    kk_std_core_hnd__resume_result _x_x371 = kk_std_core_hnd__new_Deep(x, _ctx); /*hnd/resume-result<74,75>*/
    return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x, (_x, _x_x371, _ctx), _ctx);
  }
}
...
static inline kk_box_t kk_std_core_hnd_resume_shallow(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e1 b */ 
  {
    kk_function_t _x = r.k;
    kk_std_core_hnd__resume_result _x_x372 = kk_std_core_hnd__new_Shallow(x, _ctx); /*hnd/resume-result<74,75>*/
    return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x, (_x, _x_x372, _ctx), _ctx);
  }
}
...
static inline kk_box_t kk_std_core_hnd_finalize(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : b) -> e b */ 
  {
    kk_function_t _x = r.k;
    kk_std_core_hnd__resume_result _x_x373 = kk_std_core_hnd__new_Finalize(x, _ctx); /*hnd/resume-result<74,75>*/
...
static inline kk_box_t kk_std_core_hnd__perform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,c,e> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    ...
    int32_t m = _con_x377->marker;
    kk_box_t h = _con_x377->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x249 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<5286,5287,5288,835,836>*/;
    {
...
struct kk_std_core_hnd_under1_fun385__t {
...
static inline kk_function_t kk_std_core_hnd_new_under1_fun385(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under1_fun385__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under1_fun385__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_under1_fun385, kk_context());
  _self->ev = ev;
...
static inline kk_box_t kk_std_core_hnd_under1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : (a) -> e b, x : a) -> e b */ 
  ...
  w0 = kk_evv_swap(_x_x383,kk_context()); /*hnd/evv<_5477>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), op, (op, x, _ctx), _ctx); /*5564*/;
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    kk_evv_drop(w0, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under1_fun385(ev, _ctx), _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun399__t {
  struct kk_function_s _base;
  kk_function_t clause;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun399(kk_function_t clause, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun399__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun399__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control1_fun399, kk_context());
  _self->clause = clause;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun400__t {
  struct kk_function_s _base;
  kk_function_t clause;
  kk_box_t x;
};
extern kk_box_t kk_std_core_hnd_clause_control1_fun400(kk_function_t _fself, kk_function_t k, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun400(kk_function_t clause, kk_box_t x, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun400__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun400__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control1_fun400, kk_context());
  _self->clause = clause;
  _self->x = x;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_control1(kk_function_t clause, kk_context_t* _ctx) { /* forall<a,b,e,c,d> (clause : (x : a, k : (b) -> e d) -> e d) -> clause1<a,b,c,e,d> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_control1_fun399(clause, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop1_fun405__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop1_fun405(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop1_fun405__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop1_fun405__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop1_fun405, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noop1(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d> (op : (c) -> e d) -> clause1<c,d,b,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noop1_fun405(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : forall<e1,c> (b<e1,c>) -> clause0<a,b,e1,c>) -> e a */ 
  {
    struct kk_std_core_hnd_Ev* _con_x411 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x411->marker;
    kk_box_t h = _con_x411->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause0 _match_x242 = kk_function_call(kk_std_core_hnd__clause0, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause0<6597,6599,1012,1013>*/;
    {
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun414__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun414(kk_function_t _fself, kk_function_t cont, kk_box_t res, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun414(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun414__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun414__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_under0_fun414, kk_context());
  _self->ev = ev;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_box_t kk_std_core_hnd_under0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : () -> e a) -> e a */ 
  ...
  kk_evv_t _x_x412;
  {
    ...
    kk_evv_t w = _con_x413->hevv;
    kk_evv_dup(w, _ctx);
    _x_x412 = w; /*hnd/evv<5330>*/
  }
  w0 = kk_evv_swap(_x_x412,kk_context()); /*hnd/evv<_6621>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), op, (op, _ctx), _ctx); /*6695*/;
  kk_unit_t __ = kk_Unit;
  kk_evv_set(w0,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under0_fun414(ev, _ctx), _ctx);
  }
  {
    kk_datatype_ptr_dropn(ev, (KK_I32(3)), _ctx);
    return y;
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop0_fun431__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop0_fun431(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop0_fun431__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop0_fun431__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop0_fun431, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_tail_noop0(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c> (op : () -> e c) -> clause0<c,b,e,a> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_tail_noop0_fun431(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_value_fun432__t {
  struct kk_function_s _base;
  kk_box_t v;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_value_fun432(kk_box_t v, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_value_fun432__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_value_fun432__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_value_fun432, kk_context());
  _self->v = v;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_value(kk_box_t v, kk_context_t* _ctx) { /* forall<a,e,b,c> (v : a) -> clause0<a,b,e,c> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_value_fun432(v, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun447__t {
  struct kk_function_s _base;
  kk_function_t clause;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun447(kk_function_t clause, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun447__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun447__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control2_fun447, kk_context());
  _self->clause = clause;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun448__t {
  struct kk_function_s _base;
  kk_function_t clause;
  kk_box_t x1;
  kk_box_t x2;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun448(kk_function_t clause, kk_box_t x1, kk_box_t x2, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun448__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun448__t, 4, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_control2_fun448, kk_context());
  _self->clause = clause;
  _self->x1 = x1;
  _self->x2 = x2;
  return kk_datatype_from_base(&_self->_base, kk_context());
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_control2(kk_function_t clause, kk_context_t* _ctx) { /* forall<a,b,c,e,d,a1> (clause : (x1 : a, x2 : b, k : (c) -> e a1) -> e a1) -> clause2<a,b,c,d,e,a1> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_control2_fun447(clause, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail2_fun452__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail2_fun452(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail2_fun452__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail2_fun452__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail2_fun452, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (c, d) -> e a1) -> clause2<c,d,a1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail2_fun452(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop2_fun453__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop2_fun453(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop2_fun453__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop2_fun453__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop2_fun453, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail_noop2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (c, d) -> e a1) -> clause2<c,d,a1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail_noop2_fun453(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform2(kk_std_core_hnd__ev evx, kk_function_t op, kk_box_t x, kk_box_t y, kk_context_t* _ctx) { /* forall<a,b,c,e,d> (evx : ev<d>, op : forall<e1,a1> (d<e1,a1>) -> clause2<a,b,c,d,e1,a1>, x : a, y : b) -> e c */ 
  {
    struct kk_std_core_hnd_Ev* _con_x454 = kk_std_core_hnd__as_Ev(evx, _ctx);
    int32_t m = _con_x454->marker;
    kk_box_t h = _con_x454->hnd;
    kk_box_dup(h, _ctx);
...
static inline kk_box_t kk_std_core_hnd_xperform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    ...
    int32_t m = _con_x457->marker;
    kk_box_t h = _con_x457->hnd;
    kk_box_dup(h, _ctx);
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail3_fun464__t {
  struct kk_function_s _base;
  kk_function_t op;
};
extern kk_box_t kk_std_core_hnd_clause_tail3_fun464(kk_function_t _fself, kk_box_t _b_x126, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_clause_tail3_fun464(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail3_fun464__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail3_fun464__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail3_fun464, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail3(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1,b1> (op : (c, d, a1) -> e b1) -> clause1<(c, d, a1),b1,b,e,a> */ 
  return kk_std_core_hnd_clause_tail1(kk_std_core_hnd_new_clause_tail3_fun464(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noop3_fun465__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noop3_fun465(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noop3_fun465__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noop3_fun465__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_hnd_clause_tail_noop3_fun465, kk_context());
  _self->op = op;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noop3(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1,b1> (op : (c, d, a1) -> e b1) -> clause1<(c, d, a1),b1,b,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noop3_fun465(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform3(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_context_t* _ctx) { /* forall<a,b,c,d,e,a1> (ev : ev<a1>, op : forall<e1,b1> (a1<e1,b1>) -> clause1<(a, b, c),d,a1,e1,b1>, x1 : a, x2 : b, x3 : c) -> e d */ 
  {
    struct kk_std_core_hnd_Ev* _con_x468 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x468->marker;
    kk_box_t h = _con_x468->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x227 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<(8929, 8930, 8931),8932,8934,1450,1451>*/;
    {
      kk_function_t _fun_unbox_x148 = _match_x227.clause;
      kk_box_t _x_x469;
      kk_std_core_types__tuple3 _x_x470 = kk_std_core_types__new_Tuple3(x1, x2, x3, _ctx); /*(141, 142, 143)*/
      _x_x469 = kk_std_core_types__tuple3_box(_x_x470, _ctx); /*45*/
      return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x148, (_fun_unbox_x148, m, ev, _x_x469, _ctx), _ctx);
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform4(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_box_t x4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,e,b1> (ev : ev<b1>, op : forall<e1,c1> (b1<e1,c1>) -> clause1<(a, b, c, d),a1,b1,e1,c1>, x1 : a, x2 : b, x3 : c, x4 : d) -> e a1 */ 
  {
    struct kk_std_core_hnd_Ev* _con_x488 = kk_std_core_hnd__as_Ev(ev, _ctx);
    int32_t m = _con_x488->marker;
    kk_box_t h = _con_x488->hnd;
    kk_box_dup(h, _ctx);
    kk_std_core_hnd__clause1 _match_x220 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx), _ctx); /*hnd/clause1<(9624, 9625, 9626, 9627),9628,9630,1606,1607>*/;
    {
      kk_function_t _fun_unbox_x193 = _match_x220.clause;
      kk_box_t _x_x489;
      kk_std_core_types__tuple4 _x_x490 = kk_std_core_types__new_Tuple4(kk_reuse_null, 0, x1, x2, x3, x4, _ctx); /*(150, 151, 152, 153)*/
      _x_x489 = kk_std_core_types__tuple4_box(_x_x490, _ctx); /*45*/
      return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x193, (_fun_unbox_x193, m, ev, _x_x489, _ctx), _ctx);
    }
  }
}
...
static inline kk_std_core_types__either kk_std_core_hnd_unsafe_try_finalize(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> e a) -> e either<yield-info,a> */ 
  kk_box_t _x_x519 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*11889*/
  return kk_std_core_hnd_try_finalize_prompt(_x_x519, _ctx);
}
