...
kk_unit_t kk_hot__paths__mlift_server_loop_10035(kk_std_core_types__list profiles_0, kk_integer_t total_calls_0, double total_time_0, kk_string_t line, kk_context_t* _ctx) { /* (profiles : list<path-profile>, total-calls : int, total-time : float64, line : string) -> <console/console,exn> () */ 
  ...
  if (_match_x72) {
    ...
    _x_x260 = kk_std_core_hnd__open_none1(kk_hot__paths__new_mlift_server_loop_10035_fun261(_ctx), _x_x264, _ctx); /*10001*/
    op_0 = kk_string_unbox(_x_x260); /*string*/
    kk_string_t x_10036;
    if (kk_string_cmp_cstr_borrow(op_0, "record", _ctx) == 0) {
      kk_string_t name;
      kk_box_t _x_x267 = kk_std_core_hnd__open_none1(kk_hot__paths__new_mlift_server_loop_10035_fun268(_ctx), kk_string_box(line), _ctx); /*10001*/
    ...
    if (kk_string_cmp_cstr_borrow(op_0, "profile", _ctx) == 0) {
      kk_string_t name_0;
      kk_box_t _x_x276 = kk_std_core_hnd__open_none1(kk_hot__paths__new_mlift_server_loop_10035_fun277(_ctx), kk_string_box(line), _ctx); /*10001*/
    ...
    if (kk_string_cmp_cstr_borrow(op_0, "status", _ctx) == 0) {
      ...
      kk_string_t _x_x294;
      kk_string_t _x_x295;
      kk_box_t _x_x296 = kk_std_core_hnd__open_none2(kk_hot__paths__new_mlift_server_loop_10035_fun297(_ctx), kk_double_box(total_time_0, _ctx), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*10002*/
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x305 = kk_std_core_hnd_yield_extend(kk_hot__paths__new_mlift_server_loop_10035_fun306(op_0, profiles_0, total_calls_0, total_time_0, _ctx), _ctx); /*10001*/
...
kk_unit_t kk_hot__paths_server_loop(kk_integer_t total_calls_1, double total_time_1, kk_std_core_types__list profiles_1, kk_context_t* _ctx) { /* (total-calls : int, total-time : float64, profiles : list<path-profile>) -> io () */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x308 = kk_std_core_hnd_yield_extend(kk_hot__paths_new_server_loop_fun309(profiles_1, total_calls_1, total_time_1, _ctx), _ctx); /*10001*/
  ...
  }
  {
    ...
    if (_match_x69) {
      ...
      _x_x314 = kk_std_core_hnd__open_none1(kk_hot__paths_new_server_loop_fun315(_ctx), _x_x318, _ctx); /*10001*/
      op_1 = kk_string_unbox(_x_x314); /*string*/
      kk_string_t x_1_10041;
      if (kk_string_cmp_cstr_borrow(op_1, "record", _ctx) == 0) {
        kk_string_t name_1;
        kk_box_t _x_x321 = kk_std_core_hnd__open_none1(kk_hot__paths_new_server_loop_fun322(_ctx), kk_string_box(x_0_10038), _ctx); /*10001*/
      ...
      if (kk_string_cmp_cstr_borrow(op_1, "profile", _ctx) == 0) {
        ...
        kk_box_t _x_x330 = kk_std_core_hnd__open_none1(kk_hot__paths_new_server_loop_fun331(_ctx), kk_string_box(x_0_10038), _ctx); /*10001*/
      ...
      if (kk_string_cmp_cstr_borrow(op_1, "status", _ctx) == 0) {
        ...
        kk_string_t _x_x348;
        kk_string_t _x_x349;
        kk_box_t _x_x350 = kk_std_core_hnd__open_none2(kk_hot__paths_new_server_loop_fun351(_ctx), kk_double_box(total_time_1, _ctx), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*10002*/
      ...
      if (kk_yielding(kk_context())) {
        ...
        kk_box_t _x_x359 = kk_std_core_hnd_yield_extend(kk_hot__paths_new_server_loop_fun360(op_1, profiles_1, total_calls_1, total_time_1, _ctx), _ctx); /*10001*/
