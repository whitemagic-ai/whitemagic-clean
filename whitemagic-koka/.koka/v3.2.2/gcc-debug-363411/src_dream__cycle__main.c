...
#include "src_dream__cycle__main.h"
...
void kk_src_dream__cycle__main__init(kk_context_t* _ctx){
  ...
  kk_src_dream__cycle__init(_ctx);
...
void kk_src_dream__cycle__main__done(kk_context_t* _ctx){
  ...
  kk_src_dream__cycle__done(_ctx);
...
void main_init(kk_context_t* _ctx) {
  kk_src_dream__cycle__main__init(_ctx);
}
void main_run(kk_context_t* _ctx) {
  kk_src_dream__cycle__main__main(_ctx);
}
void main_done(kk_context_t* _ctx) {
  kk_src_dream__cycle__main__done(_ctx);
}
