...
static inline kk_string_t kk_gan__ying_resonance_event_fs_source(kk_gan__ying__resonance_event _this, kk_context_t* _ctx) { /* (resonance-event) -> string */ 
  {
    struct kk_gan__ying_Resonance_event* _con_x124 = kk_gan__ying__as_Resonance_event(_this, _ctx);
    kk_string_t _x = _con_x124->source;
...
static inline kk_gan__ying__event_type kk_gan__ying_resonance_event_fs_event_type(kk_gan__ying__resonance_event _this, kk_context_t* _ctx) { /* (resonance-event) -> event-type */ 
  {
    struct kk_gan__ying_Resonance_event* _con_x125 = kk_gan__ying__as_Resonance_event(_this, _ctx);
    kk_gan__ying__event_type _x = _con_x125->event_type;
    return _x;
  }
}
...
static inline kk_string_t kk_gan__ying_resonance_event_fs_data(kk_gan__ying__resonance_event _this, kk_context_t* _ctx) { /* (resonance-event) -> string */ 
  {
    struct kk_gan__ying_Resonance_event* _con_x126 = kk_gan__ying__as_Resonance_event(_this, _ctx);
    kk_string_t _x = _con_x126->data;
    return kk_string_dup(_x, _ctx);
  }
}
...
static inline kk_integer_t kk_gan__ying_resonance_event_fs_timestamp(kk_gan__ying__resonance_event _this, kk_context_t* _ctx) { /* (resonance-event) -> int */ 
  {
    struct kk_gan__ying_Resonance_event* _con_x127 = kk_gan__ying__as_Resonance_event(_this, _ctx);
    kk_integer_t _x = _con_x127->timestamp;
...
static inline double kk_gan__ying_resonance_event_fs_confidence(kk_gan__ying__resonance_event _this, kk_context_t* _ctx) { /* (resonance-event) -> float64 */ 
  {
    struct kk_gan__ying_Resonance_event* _con_x128 = kk_gan__ying__as_Resonance_event(_this, _ctx);
    double _x = _con_x128->confidence;
    return _x;
  }
}
...
static inline kk_gan__ying__event_type kk_gan__ying_cascade_trigger_fs_event_type(kk_gan__ying__cascade_trigger _this, kk_context_t* _ctx) { /* (cascade-trigger) -> event-type */ 
  {
    struct kk_gan__ying_Cascade_trigger* _con_x139 = kk_gan__ying__as_Cascade_trigger(_this, _ctx);
    kk_gan__ying__event_type _x = _con_x139->event_type;
    return _x;
  }
}
...
static inline kk_integer_t kk_gan__ying_cascade_trigger_fs_handler_count(kk_gan__ying__cascade_trigger _this, kk_context_t* _ctx) { /* (cascade-trigger) -> int */ 
  {
    struct kk_gan__ying_Cascade_trigger* _con_x140 = kk_gan__ying__as_Cascade_trigger(_this, _ctx);
    kk_integer_t _x = _con_x140->handler_count;
    return kk_integer_dup(_x, _ctx);
  }
}
...
static inline kk_integer_t kk_gan__ying_cascade_trigger_fs_priority(kk_gan__ying__cascade_trigger _this, kk_context_t* _ctx) { /* (cascade-trigger) -> int */ 
  {
    struct kk_gan__ying_Cascade_trigger* _con_x141 = kk_gan__ying__as_Cascade_trigger(_this, _ctx);
    kk_integer_t _x = _con_x141->priority;
    return kk_integer_dup(_x, _ctx);
  }
}
...
static inline kk_std_core_types__tuple2 kk_gan__ying_emit_event(kk_string_t source, kk_gan__ying__event_type et, kk_string_t data, double confidence, kk_integer_t count, kk_context_t* _ctx) { /* (source : string, et : event-type, data : string, confidence : float64, count : int) -> (resonance-event, int) */ 
  ...
  kk_box_t _x_x162;
  kk_gan__ying__resonance_event _x_x163 = kk_gan__ying__new_Resonance_event(kk_reuse_null, 0, source, et, data, kk_integer_from_small(0), confidence, _ctx); /*gan_ying/resonance-event*/
  _x_x162 = kk_gan__ying__resonance_event_box(_x_x163, _ctx); /*134*/
  return kk_std_core_types__new_Tuple2(_x_x162, kk_integer_box(new_count, _ctx), _ctx);
}
...
static inline kk_string_t kk_gan__ying_json_response(kk_string_t op, kk_string_t result, kk_context_t* _ctx) { /* (op : string, result : string) -> string */ 
  kk_string_t _x_x168;
  kk_define_string_literal(, _s_x169, 7, "{\"op\":\"", _ctx)
  _x_x168 = kk_string_dup(_s_x169, _ctx); /*string*/
  kk_string_t _x_x170;
  kk_string_t _x_x171;
  kk_string_t _x_x172;
  kk_define_string_literal(, _s_x173, 12, "\",\"result\":\"", _ctx)
  _x_x172 = kk_string_dup(_s_x173, _ctx); /*string*/
  kk_string_t _x_x174;
  kk_string_t _x_x175;
  kk_define_string_literal(, _s_x176, 2, "\"}", _ctx)
  _x_x175 = kk_string_dup(_s_x176, _ctx); /*string*/
  _x_x174 = kk_std_core_types__lp__plus__plus__rp_(result, _x_x175, _ctx); /*string*/
  _x_x171 = kk_std_core_types__lp__plus__plus__rp_(_x_x172, _x_x174, _ctx); /*string*/
  _x_x170 = kk_std_core_types__lp__plus__plus__rp_(op, _x_x171, _ctx); /*string*/
  return kk_std_core_types__lp__plus__plus__rp_(_x_x168, _x_x170, _ctx);
}
