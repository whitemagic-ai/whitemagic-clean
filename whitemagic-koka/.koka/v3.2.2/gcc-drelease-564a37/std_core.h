...
struct kk_std_core_const_fun90__t {
...
static inline kk_function_t kk_std_core_new_const_fun90(kk_box_t kkloc_default, kk_context_t* _ctx) {
  struct kk_std_core_const_fun90__t* _self = kk_function_alloc_as(struct kk_std_core_const_fun90__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_const_fun90, kk_context());
...
static inline kk_function_t kk_std_core_const(kk_box_t kkloc_default, kk_context_t* _ctx) { /* forall<a,b> (default : a) -> ((x : b) -> a) */ 
  return kk_std_core_new_const_fun90(kkloc_default, _ctx);
}
...
static inline bool kk_std_core_default_fs_cmp_fs__lp__eq__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order _match_x81 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, x, y, _ctx), _ctx); /*order*/;
  if (kk_std_core_types__is_Eq(_match_x81, _ctx)) {
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core_default_fs_cmp_fs__lp__gt__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order x_0_10001 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, x, y, _ctx), _ctx); /*order*/;
  ...
  _match_x103: ;
  bool _brw_x80 = kk_integer_eq_borrow(_brw_x79,(kk_integer_from_small(1)),kk_context()); /*bool*/;
...
static inline kk_box_t kk_std_core_fold(kk_integer_t upto, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (upto : int, init : a, f : (int, a) -> e a) -> e a */ 
  kk_integer_t _x_x109 = kk_integer_add_small_const(upto, -1, _ctx); /*int*/
  return kk_std_core_range_fs_fold(kk_integer_from_small(0), _x_x109, init, f, _ctx);
}
...
static inline kk_box_t kk_std_core_fold_while(kk_integer_t n, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (n : int, init : a, f : (int, a) -> e maybe<a>) -> e a */ 
  kk_integer_t _x_x117 = kk_integer_add_small_const(n, -1, _ctx); /*int*/
  return kk_std_core_range_fs_fold_while(kk_integer_from_small(0), _x_x117, init, f, _ctx);
}
...
static inline bool kk_std_core_default_fs_cmp_fs__lp__gt__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  ...
  if (kk_std_core_types__is_Lt(x_0_10003, _ctx)) {
    _brw_x71 = kk_integer_from_small(-1); /*int*/
    goto _match_x119;
  }
  if (kk_std_core_types__is_Eq(x_0_10003, _ctx)) {
    _brw_x71 = kk_integer_from_small(0); /*int*/
    goto _match_x119;
  }
  {
    _brw_x71 = kk_integer_from_small(1); /*int*/
  ...
  _match_x119: ;
  bool _brw_x72 = kk_integer_eq_borrow(_brw_x71,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
...
static inline bool kk_std_core_default_fs_cmp_fs__lp__lt__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order x_0_10001 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, y, x, _ctx), _ctx); /*order*/;
...
static inline kk_unit_t kk_std_core_range_fs_for(kk_integer_t start, kk_integer_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (start : int, end : int, action : (int) -> e ()) -> e () */ 
  kk_integer_t _x_x126 = kk_integer_dup(start, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1829(action, end, _x_x126, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_for(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : (int) -> e ()) -> e () */ 
  ...
  kk_integer_t _x_x127 = kk_integer_dup(n, _ctx); /*int*/
  end_10007 = kk_integer_add_small_const(_x_x127, -1, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1829(action, end_10007, kk_integer_from_small(0), _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_repeat(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : () -> e ()) -> e () */ 
  ...
  kk_integer_t _x_x132 = kk_integer_dup(n, _ctx); /*int*/
  end_10012 = kk_integer_add_small_const(_x_x132, -1, _ctx); /*int*/
  kk_std_core__lift_repeat_10140(action, end_10012, kk_integer_from_small(0), _ctx); return kk_Unit;
}
...
static inline kk_std_core_types__maybe kk_std_core_for_while(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (n : int, action : (int) -> e maybe<a>) -> e maybe<a> */ 
  ...
  return kk_std_core_range_fs__lift_for_while_1830(action, end_10016, kk_integer_from_small(0), _ctx);
}
...
static inline kk_box_t kk_std_core_stream_fs_head(kk_std_core__stream stream, kk_context_t* _ctx) { /* forall<a> (stream : stream<a>) -> a */ 
  {
    struct kk_std_core_Next* _con_x160 = kk_std_core__as_Next(stream, _ctx);
    kk_box_t _x = _con_x160->head;
...
static inline kk_std_core__stream kk_std_core_stream_fs_tail(kk_std_core__stream stream, kk_context_t* _ctx) { /* forall<a> (stream : stream<a>) -> stream<a> */ 
  {
    struct kk_std_core_Next* _con_x161 = kk_std_core__as_Next(stream, _ctx);
    kk_std_core__stream _x = _con_x161->tail;
