...
kk_unit_t kk_std_core_debug__mlift_trace_show_10115(kk_string_t _implicit_fs_kk_file_line, kk_string_t _y_x10111, kk_context_t* _ctx) { /* forall<_e,e1> (?kk-file-line : string, string) -> e1 () */ 
  ...
  _x_x52 = kk_std_core_types__lp__plus__plus__rp_(_x_x53, _y_x10111, _ctx); /*string*/
  message_0_10004 = kk_std_core_types__lp__plus__plus__rp_(_implicit_fs_kk_file_line, _x_x52, _ctx); /*string*/
  bool _match_x36;
  kk_box_t _x_x55;
...
kk_unit_t kk_std_core_debug_trace_show(kk_box_t x, kk_function_t _implicit_fs_show, kk_string_t _implicit_fs_kk_file_line, kk_context_t* _ctx) { /* forall<a,e> (x : a, ?show : (a) -> e string, ?kk-file-line : string) -> e () */ 
  ...
  }
  {
    ...
    _x_x60 = kk_std_core_types__lp__plus__plus__rp_(_x_x61, x_0_10116, _ctx); /*string*/
    message_0_10004 = kk_std_core_types__lp__plus__plus__rp_(_implicit_fs_kk_file_line, _x_x60, _ctx); /*string*/
    bool _match_x35;
    kk_box_t _x_x63;
