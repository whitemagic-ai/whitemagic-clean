...
static inline kk_integer_t kk_std_time_calendars_coptic_days_before_month(kk_integer_t year, kk_integer_t month, kk_context_t* _ctx) { /* (year : int, month : int) -> int */ 
  ...
  kk_integer_t _x_x120 = kk_integer_add_small_const(month, -1, _ctx); /*int*/
  return kk_integer_mul((kk_integer_from_small(30)),_x_x120,kk_context());
}
...
static inline kk_integer_t kk_std_time_calendars_coptic_days_before_year(kk_integer_t year, kk_context_t* _ctx) { /* (year : int) -> int */ 
  ...
  kk_integer_t _x_x121;
  kk_integer_t _x_x122 = kk_integer_dup(year, _ctx); /*int*/
  _x_x121 = kk_integer_add_small_const(_x_x122, -1, _ctx); /*int*/
  x_10004 = kk_integer_mul((kk_integer_from_small(365)),_x_x121,kk_context()); /*int*/
...
static inline kk_integer_t kk_std_time_calendars_isow_days_before_month(kk_integer_t year, kk_integer_t month, kk_context_t* _ctx) { /* (year : int, month : int) -> int */ 
  kk_integer_drop(year, _ctx);
  kk_integer_t _x_x155 = kk_integer_add_small_const(month, -1, _ctx); /*int*/
  return kk_integer_mul((kk_integer_from_small(7)),_x_x155,kk_context());
}
