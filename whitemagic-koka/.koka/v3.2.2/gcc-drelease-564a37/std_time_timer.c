...
kk_std_core_types__tuple2 kk_std_time_timer__mlift_elapsed_10106(kk_std_time_duration__duration t0, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e> (t0 : std/time/duration/duration, x : a) -> <ndet|e> (std/time/duration/duration, a) */ 
...
static kk_box_t kk_std_time_timer_elapsed_fun47(kk_function_t _fself, kk_box_t _b_x15, kk_context_t* _ctx) {
  ...
  kk_std_core_types__tuple2 _x_x48 = kk_std_core_types__new_Tuple2(kk_std_time_duration__duration_box(_b_x12_21, _ctx), x_0_25, _ctx); /*(10037, 10038)*/
...
kk_std_core_types__tuple2 kk_std_time_timer_elapsed(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> <ndet|e> a) -> <ndet|e> (std/time/duration/duration, a) */ 
  ...
  kk_box_t x_10108 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*126*/;
  if (kk_yielding(kk_context())) {
    kk_box_drop(x_10108, _ctx);
    kk_box_t _x_x46 = kk_std_core_hnd_yield_extend(kk_std_time_timer_new_elapsed_fun47(t0, _ctx), _ctx); /*10001*/
  ...
  }
  {
    ...
    return kk_std_core_types__new_Tuple2(kk_std_time_duration__duration_box(_b_x18_23, _ctx), x_10108, _ctx);
  }
}
 
// monadic lift

kk_box_t kk_std_time_timer__mlift_print_elapsed_10107(kk_std_core_types__optional msg, kk_std_core_types__tuple2 _y_x10102, kk_context_t* _ctx) { /* forall<a,e> (msg : ? string, (std/time/duration/duration, a)) -> <ndet,console/console|e> a */ 
  {
    kk_box_t _box_x26 = _y_x10102.fst;
    kk_std_time_duration__duration t = kk_std_time_duration__duration_unbox(_box_x26, KK_BORROWED, _ctx);
    kk_box_t x = _y_x10102.snd;
    kk_box_dup(x, _ctx);
    kk_std_core_types__tuple2_drop(_y_x10102, _ctx);
    kk_unit_t __ = kk_Unit;
    kk_integer_t _b_x28_29;
    kk_integer_t _x_x49 = kk_integer_abs((kk_integer_from_small(3)),kk_context()); /*int*/
    _b_x28_29 = kk_integer_neg(_x_x49,kk_context()); /*int*/
    kk_string_t _x_x50;
    kk_string_t _x_x51;
    if (kk_std_core_types__is_Optional(msg, _ctx)) {
      ...
      _x_x51 = _uniq_msg_139; /*string*/
    }
    else {
      kk_std_core_types__optional_drop(msg, _ctx);
      kk_define_string_literal(, _s_x52, 7, "elapsed", _ctx)
    ...
    kk_std_core_types__optional _x_x59 = kk_std_core_types__new_Optional(kk_integer_box(_b_x28_29, _ctx), _ctx); /*? 10003*/
    _x_x57 = kk_std_num_ddouble_show_fixed(_x_x58, _x_x59, _ctx); /*string*/
    kk_string_t _x_x60;
    kk_define_string_literal(, _s_x61, 1, "s", _ctx)
    _x_x60 = kk_string_dup(_s_x61, _ctx); /*string*/
    _x_x56 = kk_std_core_types__lp__plus__plus__rp_(_x_x57, _x_x60, _ctx); /*string*/
...
// lift anonymous function
struct kk_std_time_timer_print_elapsed_fun62__t {
  struct kk_function_s _base;
  kk_std_core_types__optional msg;
};
static kk_box_t kk_std_time_timer_print_elapsed_fun62(kk_function_t _fself, kk_box_t _b_x31, kk_context_t* _ctx);
static kk_function_t kk_std_time_timer_new_print_elapsed_fun62(kk_std_core_types__optional msg, kk_context_t* _ctx) {
  struct kk_std_time_timer_print_elapsed_fun62__t* _self = kk_function_alloc_as(struct kk_std_time_timer_print_elapsed_fun62__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_time_timer_print_elapsed_fun62, kk_context());
  _self->msg = msg;
  return kk_datatype_from_base(&_self->_base, kk_context());
}

static kk_box_t kk_std_time_timer_print_elapsed_fun62(kk_function_t _fself, kk_box_t _b_x31, kk_context_t* _ctx) {
  struct kk_std_time_timer_print_elapsed_fun62__t* _self = kk_function_as(struct kk_std_time_timer_print_elapsed_fun62__t*, _fself, _ctx);
  kk_std_core_types__optional msg = _self->msg; /* ? string */
  kk_drop_match(_self, {kk_std_core_types__optional_dup(msg, _ctx);}, {}, _ctx)
  kk_std_core_types__tuple2 _x_x63 = kk_std_core_types__tuple2_unbox(_b_x31, KK_OWNED, _ctx); /*(std/time/duration/duration, 301)*/
  return kk_std_time_timer__mlift_print_elapsed_10107(msg, _x_x63, _ctx);
}
...
kk_box_t kk_std_time_timer_print_elapsed(kk_function_t action, kk_std_core_types__optional msg, kk_context_t* _ctx) { /* forall<a,e> (action : () -> <ndet,console/console|e> a, msg : ? string) -> <ndet,console/console|e> a */ 
  kk_std_core_types__tuple2 x_10113 = kk_std_time_timer_elapsed(action, _ctx); /*(std/time/duration/duration, 301)*/;
  if (kk_yielding(kk_context())) {
    kk_std_core_types__tuple2_drop(x_10113, _ctx);
    return kk_std_core_hnd_yield_extend(kk_std_time_timer_new_print_elapsed_fun62(msg, _ctx), _ctx);
  }
  {
    kk_box_t _box_x32 = x_10113.fst;
    kk_std_time_duration__duration t = kk_std_time_duration__duration_unbox(_box_x32, KK_BORROWED, _ctx);
    kk_box_t x_0 = x_10113.snd;
    kk_box_dup(x_0, _ctx);
    kk_std_core_types__tuple2_drop(x_10113, _ctx);
    kk_unit_t __ = kk_Unit;
    kk_integer_t _b_x34_35;
    kk_integer_t _x_x64 = kk_integer_abs((kk_integer_from_small(3)),kk_context()); /*int*/
    _b_x34_35 = kk_integer_neg(_x_x64,kk_context()); /*int*/
    kk_string_t _x_x65;
    kk_string_t _x_x66;
    if (kk_std_core_types__is_Optional(msg, _ctx)) {
      ...
      kk_string_dup(_uniq_msg_139, _ctx);
      kk_std_core_types__optional_drop(msg, _ctx);
      _x_x66 = _uniq_msg_139; /*string*/
    }
    else {
      kk_std_core_types__optional_drop(msg, _ctx);
      kk_define_string_literal(, _s_x67, 7, "elapsed", _ctx)
      _x_x66 = kk_string_dup(_s_x67, _ctx); /*string*/
    }
    kk_string_t _x_x68;
    kk_string_t _x_x69;
    kk_define_string_literal(, _s_x70, 1, " ", _ctx)
    _x_x69 = kk_string_dup(_s_x70, _ctx); /*string*/
    kk_string_t _x_x71;
    kk_string_t _x_x72;
    kk_std_num_ddouble__ddouble _x_x73;
    {
      kk_std_num_ddouble__ddouble _x = t.secs;
      _x_x73 = _x; /*std/time/timestamp/timespan*/
    }
    kk_std_core_types__optional _x_x74 = kk_std_core_types__new_Optional(kk_integer_box(_b_x34_35, _ctx), _ctx); /*? 10003*/
    _x_x72 = kk_std_num_ddouble_show_fixed(_x_x73, _x_x74, _ctx); /*string*/
    kk_string_t _x_x75;
    kk_define_string_literal(, _s_x76, 1, "s", _ctx)
    _x_x75 = kk_string_dup(_s_x76, _ctx); /*string*/
    _x_x71 = kk_std_core_types__lp__plus__plus__rp_(_x_x72, _x_x75, _ctx); /*string*/
    _x_x68 = kk_std_core_types__lp__plus__plus__rp_(_x_x69, _x_x71, _ctx); /*string*/
    _x_x65 = kk_std_core_types__lp__plus__plus__rp_(_x_x66, _x_x68, _ctx); /*string*/
