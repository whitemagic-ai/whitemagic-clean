...
#include "src_rust__bridge__main.h"
...
void kk_src_rust__bridge__main__init(kk_context_t* _ctx){
  ...
  kk_src_rust__bridge__init(_ctx);
...
void kk_src_rust__bridge__main__done(kk_context_t* _ctx){
  ...
  kk_src_rust__bridge__done(_ctx);
...
void main_init(kk_context_t* _ctx) {
  kk_src_rust__bridge__main__init(_ctx);
}
void main_run(kk_context_t* _ctx) {
  kk_src_rust__bridge__main__main(_ctx);
}
void main_done(kk_context_t* _ctx) {
  kk_src_rust__bridge__main__done(_ctx);
}
