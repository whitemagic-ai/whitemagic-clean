...
static inline kk_std_num_decimal__decimal kk_std_num_decimal__lp__tilde__rp_(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  ...
  kk_integer_t _x_x554;
  {
    kk_integer_t _x = x.num;
    kk_integer_dup(_x, _ctx);
    _x_x554 = _x; /*int*/
  }
  _x_x553 = kk_integer_neg(_x_x554,kk_context()); /*int*/
  ...
  return kk_std_num_decimal__new_Decimal(_x_x553, _x_x555, _ctx);
}
...
static inline bool kk_std_num_decimal_is_zero(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> bool */ 
  ...
  bool _brw_x543 = kk_integer_is_zero_borrow(_brw_x542); /*bool*/;
  kk_integer_drop(_brw_x542, _ctx);
  return _brw_x543;
}
...
static inline bool kk_std_num_decimal_is_pos(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> bool */ 
  ...
  bool _brw_x541 = kk_integer_gt_borrow(_brw_x540,(kk_integer_from_small(0)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x540, _ctx);
  return _brw_x541;
}
...
static inline bool kk_std_num_decimal_is_neg(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> bool */ 
  ...
  bool _brw_x539 = kk_integer_lt_borrow(_brw_x538,(kk_integer_from_small(0)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x538, _ctx);
  return _brw_x539;
}
...
static inline kk_integer_t kk_std_num_decimal_round_exp(kk_integer_t exp, kk_context_t* _ctx) { /* (exp : int) -> int */ 
  bool _match_x534 = kk_integer_is_zero_borrow(exp); /*bool*/;
  if (_match_x534) {
    kk_integer_drop(exp, _ctx);
    return kk_integer_from_small(0);
  }
  {
    kk_integer_t _x_x559 = kk_integer_div(exp,(kk_integer_from_small(7)),kk_context()); /*int*/
    return kk_integer_mul((kk_integer_from_small(7)),_x_x559,kk_context());
  }
}
...
static inline bool kk_std_num_decimal__lp__excl__eq__rp_(kk_std_num_decimal__decimal x, kk_std_num_decimal__decimal y, kk_context_t* _ctx) { /* (x : decimal, y : decimal) -> bool */ 
  kk_std_core_types__order x_0_10036 = kk_std_num_decimal_cmp(x, y, _ctx); /*order*/;
  kk_integer_t _brw_x511;
  if (kk_std_core_types__is_Lt(x_0_10036, _ctx)) {
    _brw_x511 = kk_integer_from_small(-1); /*int*/
    goto _match_x578;
  }
  if (kk_std_core_types__is_Eq(x_0_10036, _ctx)) {
    _brw_x511 = kk_integer_from_small(0); /*int*/
    goto _match_x578;
  }
  {
    _brw_x511 = kk_integer_from_small(1); /*int*/
  ...
  _match_x578: ;
  bool _brw_x512 = kk_integer_neq_borrow(_brw_x511,(kk_integer_from_small(0)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x511, _ctx);
  return _brw_x512;
}
...
static inline bool kk_std_num_decimal__lp__lt__eq__rp_(kk_std_num_decimal__decimal x, kk_std_num_decimal__decimal y, kk_context_t* _ctx) { /* (x : decimal, y : decimal) -> bool */ 
  kk_std_core_types__order x_0_10120 = kk_std_num_decimal_cmp(x, y, _ctx); /*order*/;
  kk_integer_t _brw_x464;
  if (kk_std_core_types__is_Lt(x_0_10120, _ctx)) {
    _brw_x464 = kk_integer_from_small(-1); /*int*/
    goto _match_x652;
  }
  if (kk_std_core_types__is_Eq(x_0_10120, _ctx)) {
    _brw_x464 = kk_integer_from_small(0); /*int*/
    goto _match_x652;
  }
  {
    _brw_x464 = kk_integer_from_small(1); /*int*/
  ...
  _match_x652: ;
  bool _brw_x465 = kk_integer_neq_borrow(_brw_x464,(kk_integer_from_small(1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x464, _ctx);
  return _brw_x465;
}
...
static inline bool kk_std_num_decimal__lp__eq__eq__rp_(kk_std_num_decimal__decimal x, kk_std_num_decimal__decimal y, kk_context_t* _ctx) { /* (x : decimal, y : decimal) -> bool */ 
  kk_std_core_types__order x_0_10122 = kk_std_num_decimal_cmp(x, y, _ctx); /*order*/;
  kk_integer_t _brw_x462;
  if (kk_std_core_types__is_Lt(x_0_10122, _ctx)) {
    _brw_x462 = kk_integer_from_small(-1); /*int*/
    goto _match_x653;
  }
  if (kk_std_core_types__is_Eq(x_0_10122, _ctx)) {
    _brw_x462 = kk_integer_from_small(0); /*int*/
    goto _match_x653;
  }
  {
    _brw_x462 = kk_integer_from_small(1); /*int*/
  ...
  _match_x653: ;
  bool _brw_x463 = kk_integer_eq_borrow(_brw_x462,(kk_integer_from_small(0)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x462, _ctx);
  return _brw_x463;
}
...
static inline bool kk_std_num_decimal__lp__gt__rp_(kk_std_num_decimal__decimal x, kk_std_num_decimal__decimal y, kk_context_t* _ctx) { /* (x : decimal, y : decimal) -> bool */ 
  kk_std_core_types__order x_0_10124 = kk_std_num_decimal_cmp(x, y, _ctx); /*order*/;
  kk_integer_t _brw_x460;
  if (kk_std_core_types__is_Lt(x_0_10124, _ctx)) {
    _brw_x460 = kk_integer_from_small(-1); /*int*/
    goto _match_x654;
  }
  if (kk_std_core_types__is_Eq(x_0_10124, _ctx)) {
    _brw_x460 = kk_integer_from_small(0); /*int*/
    goto _match_x654;
  }
  {
    _brw_x460 = kk_integer_from_small(1); /*int*/
  ...
  _match_x654: ;
  bool _brw_x461 = kk_integer_eq_borrow(_brw_x460,(kk_integer_from_small(1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x460, _ctx);
  return _brw_x461;
}
...
static inline bool kk_std_num_decimal__lp__gt__eq__rp_(kk_std_num_decimal__decimal x, kk_std_num_decimal__decimal y, kk_context_t* _ctx) { /* (x : decimal, y : decimal) -> bool */ 
  kk_std_core_types__order x_0_10126 = kk_std_num_decimal_cmp(x, y, _ctx); /*order*/;
  kk_integer_t _brw_x458;
  if (kk_std_core_types__is_Lt(x_0_10126, _ctx)) {
    _brw_x458 = kk_integer_from_small(-1); /*int*/
    goto _match_x655;
  }
  if (kk_std_core_types__is_Eq(x_0_10126, _ctx)) {
    _brw_x458 = kk_integer_from_small(0); /*int*/
    goto _match_x655;
  }
  {
    _brw_x458 = kk_integer_from_small(1); /*int*/
  ...
  _match_x655: ;
  bool _brw_x459 = kk_integer_neq_borrow(_brw_x458,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x458, _ctx);
  return _brw_x459;
}
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_inc(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  ...
  _x_x669 = kk_integer_add_small_const(_x_x670, 1, _ctx); /*int*/
  ...
  return kk_std_num_decimal__new_Decimal(_x_x669, _x_x671, _ctx);
}
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_dec(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  ...
  _x_x672 = kk_integer_add_small_const(_x_x673, -1, _ctx); /*int*/
  ...
  return kk_std_num_decimal__new_Decimal(_x_x672, _x_x674, _ctx);
}
...
static inline bool kk_std_num_decimal_is_even(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> bool */ 
  ...
  b_10014 = kk_integer_is_odd(_x_x675,kk_context()); /*bool*/
  if (b_10014) {
    return false;
  }
  {
...
static inline bool kk_std_num_decimal__lp__lt__rp_(kk_std_num_decimal__decimal x, kk_std_num_decimal__decimal y, kk_context_t* _ctx) { /* (x : decimal, y : decimal) -> bool */ 
  kk_std_core_types__order x_0_10171 = kk_std_num_decimal_cmp(x, y, _ctx); /*order*/;
  kk_integer_t _brw_x398;
  if (kk_std_core_types__is_Lt(x_0_10171, _ctx)) {
    _brw_x398 = kk_integer_from_small(-1); /*int*/
    goto _match_x750;
  }
  if (kk_std_core_types__is_Eq(x_0_10171, _ctx)) {
  ...
  _match_x750: ;
  bool _brw_x399 = kk_integer_eq_borrow(_brw_x398,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
...
static inline bool kk_std_num_decimal_is_odd(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> bool */ 
  ...
  return kk_integer_is_odd(_x_x801,kk_context());
}
...
static inline bool kk_std_num_decimal_is_precise(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> bool */ 
  bool _match_x347 = kk_integer_gt_borrow(i,kk_std_num_decimal_minprecise,kk_context()); /*bool*/;
  if (_match_x347) {
    bool _brw_x348 = kk_integer_lt_borrow(i,kk_std_num_decimal_maxprecise,kk_context()); /*bool*/;
...
static inline kk_integer_t kk_std_num_decimal__mlift_pdecimal_10506(kk_char_t wild___0, kk_context_t* _ctx) { /* (wild_@0 : char) -> std/text/parse/parse int */ 
...
static inline kk_string_t kk_std_num_decimal__mlift_pdecimal_10509(kk_char_t wild__, kk_context_t* _ctx) { /* (wild_ : char) -> std/text/parse/parse string */ 
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_sum(kk_std_core_types__list ds, kk_context_t* _ctx) { /* (ds : list<decimal>) -> decimal */ 
  kk_std_num_decimal__decimal _x_x910 = kk_std_num_decimal__decimal_dup(kk_std_num_decimal_zero, _ctx); /*std/num/decimal/decimal*/
  return kk_std_num_decimal__lift_sum_10480(ds, _x_x910, _ctx);
}
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_floor(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  kk_std_core_types__optional _x_x911 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x912 = kk_std_core_types__new_Optional(kk_std_num_decimal__round_box(kk_std_num_decimal__new_Floor(_ctx), _ctx), _ctx); /*? 10003*/
  return kk_std_num_decimal_round_to_prec(x, _x_x911, _x_x912, _ctx);
}
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_ceiling(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  kk_std_core_types__optional _x_x913 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x914 = kk_std_core_types__new_Optional(kk_std_num_decimal__round_box(kk_std_num_decimal__new_Ceiling(_ctx), _ctx), _ctx); /*? 10003*/
  return kk_std_num_decimal_round_to_prec(x, _x_x913, _x_x914, _ctx);
}
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_truncate(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  kk_std_core_types__optional _x_x915 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x916 = kk_std_core_types__new_Optional(kk_std_num_decimal__round_box(kk_std_num_decimal__new_Truncate(_ctx), _ctx), _ctx); /*? 10003*/
  return kk_std_num_decimal_round_to_prec(x, _x_x915, _x_x916, _ctx);
}
