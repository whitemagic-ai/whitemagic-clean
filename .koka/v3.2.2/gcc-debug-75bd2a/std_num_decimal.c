...
kk_std_num_decimal__decimal kk_std_num_decimal_expand(kk_std_num_decimal__decimal x, kk_integer_t e, kk_context_t* _ctx) { /* (x : decimal, e : int) -> decimal */ 
  ...
  }
  {
    ...
    kk_std_core_types__optional _x_x452 = kk_std_core_types__new_Optional(kk_integer_box(e, _ctx), _ctx); /*? 10003*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_reduce(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  ...
  if (b_10032) {
    ...
    }
    {
      ...
      kk_std_core_types__optional _x_x462 = kk_std_core_types__new_Optional(kk_integer_box(expp, _ctx), _ctx); /*? 10003*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__lp__star__rp_(kk_std_num_decimal__decimal x, kk_std_num_decimal__decimal y, kk_context_t* _ctx) { /* (x : decimal, y : decimal) -> decimal */ 
  ...
  kk_std_core_types__optional _x_x468 = kk_std_core_types__new_Optional(kk_integer_box(_b_x10_11, _ctx), _ctx); /*? 10003*/
  ...
  }
  {
    ...
    }
    {
      ...
      if (_match_x378) {
        ...
        kk_std_core_types__optional _x_x493 = kk_std_core_types__new_Optional(kk_integer_box(_b_x13_15, _ctx), _ctx); /*? 10003*/
        ...
        kk_std_core_types__optional _x_x497 = kk_std_core_types__new_Optional(kk_integer_box(_b_x14_16, _ctx), _ctx); /*? 10003*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_int_fs_decimal(kk_integer_t i, kk_std_core_types__optional exp, kk_context_t* _ctx) { /* (i : int, exp : ? int) -> decimal */ 
  ...
  _x_x509 = kk_integer_box(_x_x510, _ctx); /*10003*/
  _x_x508 = kk_std_core_types__new_Optional(_x_x509, _ctx); /*? 10003*/
  ...
  }
  {
    ...
    if (b_10099) {
      ...
      _match_x363 = kk_std_core_int_divmod_exp10(_x_x521, _x_x522, _ctx); /*(int, int)*/
      {
        ...
        kk_std_core_types__optional _x_x531 = kk_std_core_types__new_Optional(kk_integer_box(_b_x26_27, _ctx), _ctx); /*? 10003*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_round(kk_std_num_decimal__decimal x, kk_std_core_types__optional rnd, kk_context_t* _ctx) { /* (x : decimal, rnd : ? round) -> decimal */ 
  kk_std_core_types__optional _x_x532 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x533;
  kk_box_t _x_x534;
  kk_std_num_decimal__round _x_x535;
  if (kk_std_core_types__is_Optional(rnd, _ctx)) {
    kk_box_t _box_x29 = rnd._cons._Optional.value;
    kk_std_num_decimal__round _uniq_rnd_2225 = kk_std_num_decimal__round_unbox(_box_x29, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(rnd, _ctx);
    _x_x535 = _uniq_rnd_2225; /*std/num/decimal/round*/
  }
  else {
    kk_std_core_types__optional_drop(rnd, _ctx);
    _x_x535 = kk_std_num_decimal__new_Half_even(_ctx); /*std/num/decimal/round*/
  }
  _x_x534 = kk_std_num_decimal__round_box(_x_x535, _ctx); /*10003*/
  _x_x533 = kk_std_core_types__new_Optional(_x_x534, _ctx); /*? 10003*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_pow(kk_std_num_decimal__decimal x, kk_integer_t n, kk_context_t* _ctx) { /* (x : decimal, n : int) -> decimal */ 
  ...
  kk_std_core_types__optional _x_x543 = kk_std_core_types__new_Optional(kk_integer_box(_b_x33_34, _ctx), _ctx); /*? 10003*/
  ...
  if (_match_x359) {
    ...
    kk_std_core_types__optional _x_x545 = kk_std_core_types__new_Optional(kk_integer_box(_b_x36_38, _ctx), _ctx); /*? 10003*/
    _x_x544 = kk_std_num_decimal_decimal_exp(kk_integer_from_small(1), _x_x545, _ctx); /*std/num/decimal/decimal*/
    kk_std_core_types__optional _x_x546 = kk_std_core_types__new_Optional(kk_integer_box(_b_x37_39, _ctx), _ctx); /*? 10003*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_float64_fs_decimal(double d, kk_std_core_types__optional max_prec, kk_context_t* _ctx) { /* (d : float64, max-prec : ? int) -> decimal */ 
  kk_std_core_types__tuple2 _match_x348 = kk_std_num_float64_decode(d, _ctx); /*(int, int)*/;
  {
    ...
    if (_match_x349) {
      ...
      _x_x549 = kk_integer_box(_x_x550, _ctx); /*10003*/
      _x_x548 = kk_std_core_types__new_Optional(_x_x549, _ctx); /*? 10003*/
    ...
    }
    {
      ...
      if (kk_std_core_types__is_Optional(max_prec, _ctx)) {
        ...
        kk_integer_t _uniq_max_prec_2404 = kk_integer_unbox(_box_x44, _ctx);
        kk_integer_dup(_uniq_max_prec_2404, _ctx);
        _brw_x356 = _uniq_max_prec_2404; /*int*/
      }
      else {
      ...
      if (_match_x352) {
        ...
        if (kk_std_core_types__is_Optional(max_prec, _ctx)) {
          ...
          kk_integer_t _uniq_max_prec_2404_0 = kk_integer_unbox(_box_x45, _ctx);
          kk_integer_dup(_uniq_max_prec_2404_0, _ctx);
          _brw_x354 = _uniq_max_prec_2404_0; /*int*/
        }
        else {
        ...
        if (_match_x353) {
          ...
          if (kk_std_core_types__is_Optional(max_prec, _ctx)) {
            ...
            kk_integer_t _uniq_max_prec_2404_1 = kk_integer_unbox(_box_x46, _ctx);
      ...
      kk_std_core_types__optional _x_x554 = kk_std_core_types__new_Optional(kk_integer_box(_b_x48_53, _ctx), _ctx); /*? 10003*/
      ...
      kk_std_core_types__optional _x_x557 = kk_std_core_types__new_Optional(kk_integer_box(_b_x50_54, _ctx), _ctx); /*? 10003*/
      ...
      kk_std_core_types__optional _x_x559 = kk_std_core_types__new_Optional(kk_integer_box(prec, _ctx), _ctx); /*? 10003*/
...
kk_integer_t kk_std_num_decimal_int(kk_std_num_decimal__decimal x, kk_std_core_types__optional rnd, kk_context_t* _ctx) { /* (x : decimal, rnd : ? round) -> int */ 
  kk_std_num_decimal__decimal y;
  kk_std_core_types__optional _x_x561 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x562;
  kk_box_t _x_x563;
  kk_std_num_decimal__round _x_x564;
  if (kk_std_core_types__is_Optional(rnd, _ctx)) {
    kk_box_t _box_x57 = rnd._cons._Optional.value;
    kk_std_num_decimal__round _uniq_rnd_2758 = kk_std_num_decimal__round_unbox(_box_x57, KK_BORROWED, _ctx);
    kk_std_core_types__optional_drop(rnd, _ctx);
    _x_x564 = _uniq_rnd_2758; /*std/num/decimal/round*/
  }
  else {
    kk_std_core_types__optional_drop(rnd, _ctx);
    _x_x564 = kk_std_num_decimal__new_Half_even(_ctx); /*std/num/decimal/round*/
  }
  _x_x563 = kk_std_num_decimal__round_box(_x_x564, _ctx); /*10003*/
  _x_x562 = kk_std_core_types__new_Optional(_x_x563, _ctx); /*? 10003*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_pdecimal_10263(kk_string_t frac, bool neg, kk_string_t whole, kk_integer_t exp, kk_context_t* _ctx) { /* (frac : string, neg : bool, whole : string, exp : int) -> std/text/parse/parse decimal */ 
  ...
  kk_box_t _x_x569 = kk_std_core_hnd__open_none2(kk_std_num_decimal__new_mlift_pdecimal_10263_fun570(_ctx), kk_string_box(_x_x1_1_10259), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*10002*/
  _x_x1_0_10257 = kk_std_core_types__maybe_unbox(_x_x569, KK_OWNED, _ctx); /*maybe<int>*/
  kk_integer_t _x_x1_10255;
  kk_box_t _x_x574 = kk_std_core_hnd__open_none2(kk_std_num_decimal__new_mlift_pdecimal_10263_fun575(_ctx), kk_std_core_types__maybe_box(_x_x1_0_10257, _ctx), kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*10002*/
  ...
  kk_box_t _x_x577;
  kk_box_t _x_x582;
  kk_std_core_types__optional _x_x583 = kk_std_core_types__new_Optional(kk_integer_box(_b_x83_84, _ctx), _ctx); /*? 10003*/
  _x_x582 = kk_std_core_types__optional_box(_x_x583, _ctx); /*10001*/
  _x_x577 = kk_std_core_hnd__open_none2(kk_std_num_decimal__new_mlift_pdecimal_10263_fun578(_ctx), kk_integer_box(_x_x1_10255, _ctx), _x_x582, _ctx); /*10002*/
  i = kk_std_num_decimal__decimal_unbox(_x_x577, KK_OWNED, _ctx); /*std/num/decimal/decimal*/
  if (neg) {
    kk_box_t _x_x584 = kk_std_core_hnd__open_none1(kk_std_num_decimal__new_mlift_pdecimal_10263_fun585(_ctx), kk_std_num_decimal__decimal_box(i, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_num_decimal__mlift_pdecimal_10265_fun591(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x595 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10265_fun596(_ctx), _ctx); /*10001*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_pdecimal_10265(bool neg, kk_string_t whole, kk_string_t frac, kk_context_t* _ctx) { /* (neg : bool, whole : string, frac : string) -> std/text/parse/parse decimal */ 
  ...
  kk_box_t _x_x590 = kk_std_text_parse__lp__bar__bar__rp_(kk_std_num_decimal__new_mlift_pdecimal_10265_fun591(_ctx), kk_std_num_decimal__new_mlift_pdecimal_10265_fun599(_ctx), _ctx); /*10000*/
  x_10270 = kk_integer_unbox(_x_x590, _ctx); /*int*/
  if (kk_yielding(kk_context())) {
    kk_integer_drop(x_10270, _ctx);
    kk_box_t _x_x600 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10265_fun601(frac, whole, neg, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_num_decimal__mlift_pdecimal_10266_fun604(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_string_t _x_x605;
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x606 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10266_fun607(_ctx), _ctx); /*10001*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_pdecimal_10266(bool neg, kk_string_t whole, kk_context_t* _ctx) { /* (neg : bool, whole : string) -> std/text/parse/parse decimal */ 
  kk_string_t x_10274;
  kk_box_t _x_x603 = kk_std_text_parse__lp__bar__bar__rp_(kk_std_num_decimal__new_mlift_pdecimal_10266_fun604(_ctx), kk_std_num_decimal__new_mlift_pdecimal_10266_fun610(_ctx), _ctx); /*10000*/
  x_10274 = kk_string_unbox(_x_x603); /*string*/
  if (kk_yielding(kk_context())) {
    kk_string_drop(x_10274, _ctx);
    kk_box_t _x_x613 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10266_fun614(whole, neg, _ctx), _ctx); /*10001*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_pdecimal_10267(bool neg, kk_context_t* _ctx) { /* (neg : bool) -> std/text/parse/parse decimal */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x616 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_pdecimal_10267_fun617(neg, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_num_decimal_pdecimal_fun627(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_string_t _x_x628;
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x629 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun630(_ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_num_decimal_pdecimal_fun640(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x644 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun645(_ctx), _ctx); /*10001*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_pdecimal(kk_context_t* _ctx) { /* () -> std/text/parse/parse decimal */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x619 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun620(_ctx), _ctx); /*10001*/
  ...
  }
  {
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x623 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun624(x_10280, _ctx), _ctx); /*10001*/
      return kk_std_num_decimal__decimal_unbox(_x_x623, KK_OWNED, _ctx);
    }
    {
      kk_string_t x_1_10286;
      kk_box_t _x_x626 = kk_std_text_parse__lp__bar__bar__rp_(kk_std_num_decimal_new_pdecimal_fun627(_ctx), kk_std_num_decimal_new_pdecimal_fun633(_ctx), _ctx); /*10000*/
      x_1_10286 = kk_string_unbox(_x_x626); /*string*/
      if (kk_yielding(kk_context())) {
        kk_string_drop(x_1_10286, _ctx);
        kk_box_t _x_x636 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun637(x_0_10283, x_10280, _ctx), _ctx); /*10001*/
        return kk_std_num_decimal__decimal_unbox(_x_x636, KK_OWNED, _ctx);
      }
      {
        kk_integer_t x_3_10291;
        kk_box_t _x_x639 = kk_std_text_parse__lp__bar__bar__rp_(kk_std_num_decimal_new_pdecimal_fun640(_ctx), kk_std_num_decimal_new_pdecimal_fun648(_ctx), _ctx); /*10000*/
        x_3_10291 = kk_integer_unbox(_x_x639, _ctx); /*int*/
        if (kk_yielding(kk_context())) {
          kk_integer_drop(x_3_10291, _ctx);
          kk_box_t _x_x649 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_pdecimal_fun650(x_0_10283, x_1_10286, x_10280, _ctx), _ctx); /*10001*/
        ...
        }
        {
          ...
          kk_std_core_types__maybe _x_x1_0_10257;
          kk_box_t _x_x653 = kk_std_core_hnd__open_none2(kk_std_num_decimal_new_pdecimal_fun654(_ctx), kk_string_box(_x_x1_1_10259), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*10002*/
          _x_x1_0_10257 = kk_std_core_types__maybe_unbox(_x_x653, KK_OWNED, _ctx); /*maybe<int>*/
          kk_integer_t _x_x1_10255;
          kk_box_t _x_x658 = kk_std_core_hnd__open_none2(kk_std_num_decimal_new_pdecimal_fun659(_ctx), kk_std_core_types__maybe_box(_x_x1_0_10257, _ctx), kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*10002*/
          ...
          kk_box_t _x_x661;
          kk_box_t _x_x666;
          kk_std_core_types__optional _x_x667 = kk_std_core_types__new_Optional(kk_integer_box(_b_x169_170, _ctx), _ctx); /*? 10003*/
          _x_x666 = kk_std_core_types__optional_box(_x_x667, _ctx); /*10001*/
          _x_x661 = kk_std_core_hnd__open_none2(kk_std_num_decimal_new_pdecimal_fun662(_ctx), kk_integer_box(_x_x1_10255, _ctx), _x_x666, _ctx); /*10002*/
          i = kk_std_num_decimal__decimal_unbox(_x_x661, KK_OWNED, _ctx); /*std/num/decimal/decimal*/
          if (x_10280) {
            kk_box_t _x_x668 = kk_std_core_hnd__open_none1(kk_std_num_decimal_new_pdecimal_fun669(_ctx), kk_std_num_decimal__decimal_box(i, _ctx), _ctx); /*10001*/
...
kk_std_num_decimal__decimal kk_std_num_decimal__mlift_parse_decimal_10269(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> std/text/parse/parse decimal */ 
  ...
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x674 = kk_std_core_hnd_yield_extend(kk_std_num_decimal__new_mlift_parse_decimal_10269_fun675(x, _ctx), _ctx); /*10001*/
...
static kk_box_t kk_std_num_decimal_parse_decimal_fun679(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x681 = kk_std_core_hnd_yield_extend(kk_std_num_decimal_new_parse_decimal_fun682(_ctx), _ctx); /*10001*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_sum(kk_std_core_types__list ds, kk_context_t* _ctx) { /* (ds : list<decimal>) -> decimal */ 
  ...
  _x_x688 = kk_std_num_decimal__decimal_box(_x_x689, _ctx); /*10002*/
  _x_x687 = kk_std_core_list_foldr(ds, _x_x688, kk_std_num_decimal_new_sum_fun690(_ctx), _ctx); /*10002*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_fraction(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  ...
  if (b_10172) {
    ...
    kk_std_core_types__optional _x_x715 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
    kk_std_core_types__optional _x_x716 = kk_std_core_types__new_Optional(kk_std_num_decimal__round_box(kk_std_num_decimal__new_Truncate(_ctx), _ctx), _ctx); /*? 10003*/
...
kk_std_num_decimal__decimal kk_std_num_decimal_ffraction(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  ...
  if (b_10180) {
    ...
    kk_std_core_types__optional _x_x726 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
    kk_std_core_types__optional _x_x727 = kk_std_core_types__new_Optional(kk_std_num_decimal__round_box(kk_std_num_decimal__new_Floor(_ctx), _ctx), _ctx); /*? 10003*/
...
kk_string_t kk_std_num_decimal_show_frac(kk_string_t frac, kk_integer_t prec, kk_context_t* _ctx) { /* (frac : string, prec : int) -> string */ 
  ...
  if (_match_x303) {
    ...
    kk_std_core_types__optional _x_x740 = kk_std_core_types__new_Optional(kk_char_box('0', _ctx), _ctx); /*? 10003*/
...
kk_string_t kk_std_num_decimal_show_exp(kk_std_num_decimal__decimal d, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (d : decimal, prec : ? int) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(prec, _ctx)) {
    ...
    kk_integer_t _uniq_prec_3571 = kk_integer_unbox(_box_x238, _ctx);
    kk_integer_dup(_uniq_prec_3571, _ctx);
    _x_x747 = _uniq_prec_3571; /*int*/
  }
  else {
  ...
  kk_std_core_types__optional _x_x750 = kk_std_core_types__new_Optional(kk_integer_box(_b_x239_240, _ctx), _ctx); /*? 10003*/
  ...
  if (kk_std_core_types__is_Optional(prec, _ctx)) {
    ...
    kk_integer_t _uniq_prec_3571_0 = kk_integer_unbox(_box_x241, _ctx);
    kk_integer_dup(_uniq_prec_3571_0, _ctx);
    _brw_x295 = _uniq_prec_3571_0; /*int*/
  }
  else {
  ...
  if (_match_x292) {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_3571_1 = kk_integer_unbox(_box_x242, _ctx);
      kk_integer_dup(_uniq_prec_3571_1, _ctx);
      kk_std_core_types__optional_drop(prec, _ctx);
      _brw_x293 = _uniq_prec_3571_1; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(prec, _ctx);
    ...
    kk_std_core_types__optional _x_x768 = kk_std_core_types__new_Optional(kk_char_box('0', _ctx), _ctx); /*? 10003*/
...
kk_string_t kk_std_num_decimal_show_fixed(kk_std_num_decimal__decimal d, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (d : decimal, prec : ? int) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(prec, _ctx)) {
    ...
    kk_integer_t _uniq_prec_3981 = kk_integer_unbox(_box_x245, _ctx);
    kk_integer_dup(_uniq_prec_3981, _ctx);
    _x_x779 = _uniq_prec_3981; /*int*/
  }
  else {
  ...
  kk_std_num_decimal__decimal x;
  kk_std_core_types__optional _x_x780 = kk_std_core_types__new_Optional(kk_integer_box(_b_x246_247, _ctx), _ctx); /*? 10003*/
  ...
  if (_match_x274) {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_3981_0 = kk_integer_unbox(_box_x248, _ctx);
      kk_integer_dup(_uniq_prec_3981_0, _ctx);
      _brw_x287 = _uniq_prec_3981_0; /*int*/
    }
    else {
    ...
    if (_match_x286) {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_3981_1 = kk_integer_unbox(_box_x249, _ctx);
        kk_integer_dup(_uniq_prec_3981_1, _ctx);
        kk_std_core_types__optional_drop(prec, _ctx);
        _x_x788 = _uniq_prec_3981_1; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(prec, _ctx);
  ...
  }
  {
    ...
    kk_std_core_types__optional _x_x805 = kk_std_core_types__new_Optional(kk_char_box('0', _ctx), _ctx); /*? 10003*/
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_3981_2 = kk_integer_unbox(_box_x252, _ctx);
      kk_integer_dup(_uniq_prec_3981_2, _ctx);
      _brw_x279 = _uniq_prec_3981_2; /*int*/
    }
    else {
    ...
    if (_match_x276) {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_3981_3 = kk_integer_unbox(_box_x253, _ctx);
        kk_integer_dup(_uniq_prec_3981_3, _ctx);
        kk_std_core_types__optional_drop(prec, _ctx);
        _brw_x277 = _uniq_prec_3981_3; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(prec, _ctx);
      ...
      kk_std_core_types__optional _x_x808 = kk_std_core_types__new_Optional(kk_char_box('0', _ctx), _ctx); /*? 10003*/
...
kk_string_t kk_std_num_decimal_show(kk_std_num_decimal__decimal d, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (d : decimal, prec : ? int) -> string */ 
  ...
  if (_match_x267) {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_3446 = kk_integer_unbox(_box_x256, _ctx);
      kk_integer_dup(_uniq_prec_3446, _ctx);
      _brw_x270 = _uniq_prec_3446; /*int*/
    }
    else {
    ...
    if (_match_x269) {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_3446_0 = kk_integer_unbox(_box_x257, _ctx);
        kk_integer_dup(_uniq_prec_3446_0, _ctx);
        _brw_x272 = _uniq_prec_3446_0; /*int*/
      }
      else {
    ...
    if (_match_x268) {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_3446_1 = kk_integer_unbox(_box_x258, _ctx);
        kk_integer_dup(_uniq_prec_3446_1, _ctx);
        kk_std_core_types__optional_drop(prec, _ctx);
        _x_x822 = _uniq_prec_3446_1; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(prec, _ctx);
        _x_x822 = kk_integer_from_small(-1000); /*int*/
      }
      _x_x821 = kk_integer_box(_x_x822, _ctx); /*10003*/
      _x_x820 = kk_std_core_types__new_Optional(_x_x821, _ctx); /*? 10003*/
    ...
    }
    {
      ...
      if (kk_std_core_types__is_Optional(prec, _ctx)) {
        ...
        kk_integer_t _uniq_prec_3446_2 = kk_integer_unbox(_box_x260, _ctx);
        kk_integer_dup(_uniq_prec_3446_2, _ctx);
        kk_std_core_types__optional_drop(prec, _ctx);
        _x_x825 = _uniq_prec_3446_2; /*int*/
      }
      else {
        kk_std_core_types__optional_drop(prec, _ctx);
        _x_x825 = kk_integer_from_small(-1000); /*int*/
      }
      _x_x824 = kk_integer_box(_x_x825, _ctx); /*10003*/
      _x_x823 = kk_std_core_types__new_Optional(_x_x824, _ctx); /*? 10003*/
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(prec, _ctx)) {
      ...
      kk_integer_t _uniq_prec_3446_3 = kk_integer_unbox(_box_x262, _ctx);
      kk_integer_dup(_uniq_prec_3446_3, _ctx);
      kk_std_core_types__optional_drop(prec, _ctx);
      _x_x828 = _uniq_prec_3446_3; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(prec, _ctx);
      _x_x828 = kk_integer_from_small(-1000); /*int*/
    }
    _x_x827 = kk_integer_box(_x_x828, _ctx); /*10003*/
    _x_x826 = kk_std_core_types__new_Optional(_x_x827, _ctx); /*? 10003*/
