...
#include "whitemagic_dash_koka_src_shm__consumer__main.h"
...
void kk_whitemagic_dash_koka_src_shm__consumer__main__init(kk_context_t* _ctx){
  ...
  kk_whitemagic_dash_koka_src_shm__consumer__init(_ctx);
...
void kk_whitemagic_dash_koka_src_shm__consumer__main__done(kk_context_t* _ctx){
  ...
  kk_whitemagic_dash_koka_src_shm__consumer__done(_ctx);
...
void main_init(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_shm__consumer__main__init(_ctx);
}
void main_run(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_shm__consumer__main__main(_ctx);
}
void main_done(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_shm__consumer__main__done(_ctx);
}
