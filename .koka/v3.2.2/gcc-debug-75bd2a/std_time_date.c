...
kk_std_time_date__clock kk_std_time_date_clock_fs__copy(kk_std_time_date__clock _this, kk_std_core_types__optional hours, kk_std_core_types__optional minutes, kk_std_core_types__optional seconds, kk_context_t* _ctx) { /* (clock, hours : ? int, minutes : ? int, seconds : ? std/num/ddouble/ddouble) -> clock */ 
  ...
  if (kk_std_core_types__is_Optional(minutes, _ctx)) {
    ...
    _x_x231 = _uniq_minutes_2874; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(minutes, _ctx);
    {
  ...
  if (kk_std_core_types__is_Optional(seconds, _ctx)) {
    ...
    _x_x233 = _uniq_seconds_2882; /*std/num/ddouble/ddouble*/
  }
  else {
    kk_std_core_types__optional_drop(seconds, _ctx);
    {
  ...
  kk_std_core_types__tuple2 _match_x121 = kk_std_core_int_divmod(seconds, kk_integer_from_small(60), _ctx); /*(int, int)*/;
  {
    ...
    kk_std_core_types__tuple2 _match_x122 = kk_std_core_int_divmod(hm, kk_integer_from_small(60), _ctx); /*(int, int)*/;
    {
      ...
      if (kk_std_core_types__is_Optional(frac, _ctx)) {
        ...
        _x_x237 = _uniq_frac_2896; /*std/num/ddouble/ddouble*/
      }
      else {
        kk_std_core_types__optional_drop(frac, _ctx);
  ...
  kk_std_core_types__tuple2 _match_x118 = kk_std_core_int_divmod(seconds_0_10059, kk_integer_from_small(60), _ctx); /*(int, int)*/;
  {
    ...
    kk_std_core_types__tuple2 _match_x119 = kk_std_core_int_divmod(hm, kk_integer_from_small(60), _ctx); /*(int, int)*/;
    {
      ...
      if (kk_std_core_types__is_Optional(_match_x120, _ctx)) {
        ...
        _x_x241 = _uniq_frac_2896; /*std/num/ddouble/ddouble*/
      }
      else {
        kk_std_core_types__optional_drop(_match_x120, _ctx);
  ...
  kk_std_core_types__tuple2 _match_x113 = kk_std_core_int_divmod(seconds_0_10066, kk_integer_from_small(60), _ctx); /*(int, int)*/;
  {
    ...
    kk_std_core_types__tuple2 _match_x114 = kk_std_core_int_divmod(hm, kk_integer_from_small(60), _ctx); /*(int, int)*/;
    {
      ...
      if (kk_std_core_types__is_Optional(_match_x115, _ctx)) {
        ...
        _x_x250 = _uniq_frac_2896; /*std/num/ddouble/ddouble*/
      }
      else {
        kk_std_core_types__optional_drop(_match_x115, _ctx);
...
kk_string_t kk_std_time_date_show_seconds(kk_std_num_ddouble__ddouble secs, kk_std_core_types__optional max_prec, kk_std_core_types__optional secs_width, kk_std_core_types__optional unit, kk_context_t* _ctx) { /* (secs : std/num/ddouble/ddouble, max-prec : ? int, secs-width : ? int, unit : ? string) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(max_prec, _ctx)) {
    ...
    kk_integer_t _uniq_max_prec_3168 = kk_integer_unbox(_box_x30, _ctx);
    kk_integer_dup(_uniq_max_prec_3168, _ctx);
    kk_std_core_types__optional_drop(max_prec, _ctx);
    _x_x272 = _uniq_max_prec_3168; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(max_prec, _ctx);
  ...
  kk_string_t s;
  kk_std_core_types__optional _x_x273 = kk_std_core_types__new_Optional(kk_integer_box(_b_x31_32, _ctx), _ctx); /*? 10003*/
  ...
  if (kk_std_core_types__is_Nothing(_match_x98, _ctx)) {
    ...
    if (kk_std_core_types__is_Optional(secs_width, _ctx)) {
      ...
      kk_integer_t _uniq_secs_width_3172 = kk_integer_unbox(_box_x33, _ctx);
      kk_integer_dup(_uniq_secs_width_3172, _ctx);
      kk_std_core_types__optional_drop(secs_width, _ctx);
      _brw_x103 = _uniq_secs_width_3172; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(secs_width, _ctx);
    ...
    kk_std_core_types__optional _x_x277 = kk_std_core_types__new_Optional(kk_char_box('0', _ctx), _ctx); /*? 10003*/
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(secs_width, _ctx)) {
      ...
      kk_std_core_types__optional_drop(secs_width, _ctx);
      _brw_x100 = _uniq_secs_width_3172_0; /*int*/
    }
    else {
      kk_std_core_types__optional_drop(secs_width, _ctx);
    ...
    kk_std_core_types__optional _x_x285 = kk_std_core_types__new_Optional(kk_char_box(_b_x37_41, _ctx), _ctx); /*? 10003*/
    ...
    kk_std_core_types__optional _x_x291 = kk_std_core_types__new_Optional(kk_char_box(_b_x38_42, _ctx), _ctx); /*? 10003*/
    ...
    if (kk_std_core_types__is_Optional(unit, _ctx)) {
      ...
      kk_string_t _uniq_unit_3176 = kk_string_unbox(_box_x39);
      kk_string_dup(_uniq_unit_3176, _ctx);
      kk_std_core_types__optional_drop(unit, _ctx);
      _x_x292 = _uniq_unit_3176; /*string*/
    }
    else {
      kk_std_core_types__optional_drop(unit, _ctx);
...
kk_string_t kk_std_time_date_show0(kk_integer_t i, kk_std_core_types__optional width, kk_context_t* _ctx) { /* (i : int, width : ? int) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(width, _ctx)) {
    ...
    kk_integer_t _uniq_width_4546 = kk_integer_unbox(_box_x43, _ctx);
    kk_integer_dup(_uniq_width_4546, _ctx);
    kk_std_core_types__optional_drop(width, _ctx);
    _brw_x95 = _uniq_width_4546; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(width, _ctx);
  ...
  kk_std_core_types__optional _x_x308 = kk_std_core_types__new_Optional(kk_char_box('0', _ctx), _ctx); /*? 10003*/
...
kk_string_t kk_std_time_date_show_year(kk_integer_t year, kk_context_t* _ctx) { /* (year : int) -> string */ 
  ...
  if (_match_x88) {
    ...
    kk_std_core_types__optional _x_x312 = kk_std_core_types__new_Optional(kk_char_box(_b_x46_49, _ctx), _ctx); /*? 10003*/
  ...
  }
  {
    ...
    if (_match_x89) {
      ...
      kk_std_core_types__optional _x_x316 = kk_std_core_types__new_Optional(kk_char_box(_b_x47_50, _ctx), _ctx); /*? 10003*/
    ...
    }
    {
      ...
      kk_std_core_types__optional _x_x320 = kk_std_core_types__new_Optional(kk_char_box(_b_x48_51, _ctx), _ctx); /*? 10003*/
...
kk_string_t kk_std_time_date_show(kk_std_time_date__date d, kk_std_core_types__optional month_prefix, kk_context_t* _ctx) { /* (d : date, month-prefix : ? string) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(month_prefix, _ctx)) {
    ...
    kk_string_t _uniq_month_prefix_4332 = kk_string_unbox(_box_x52);
    kk_string_dup(_uniq_month_prefix_4332, _ctx);
    _x_x321 = _uniq_month_prefix_4332; /*string*/
  }
  else {
  ...
  if (kk_std_core_types__is_Optional(month_prefix, _ctx)) {
    ...
    kk_string_t _uniq_month_prefix_4332_0 = kk_string_unbox(_box_x53);
    kk_string_dup(_uniq_month_prefix_4332_0, _ctx);
    kk_std_core_types__optional_drop(month_prefix, _ctx);
    _x_x331 = _uniq_month_prefix_4332_0; /*string*/
  }
  else {
    kk_std_core_types__optional_drop(month_prefix, _ctx);
  ...
  if (kk_std_core_types__is_Optional(_match_x83, _ctx)) {
    ...
    kk_integer_t _uniq_width_4546 = kk_integer_unbox(_box_x54, _ctx);
    kk_integer_dup(_uniq_width_4546, _ctx);
    kk_std_core_types__optional_drop(_match_x83, _ctx);
    _brw_x84 = _uniq_width_4546; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x83, _ctx);
  ...
  kk_std_core_types__optional _x_x336 = kk_std_core_types__new_Optional(kk_char_box(_b_x55_57, _ctx), _ctx); /*? 10003*/
  ...
  kk_std_core_types__optional _x_x342 = kk_std_core_types__new_Optional(kk_char_box(_b_x56_58, _ctx), _ctx); /*? 10003*/
...
kk_string_t kk_std_time_date_clock_fs_show(kk_std_time_date__clock c, kk_std_core_types__optional prec, kk_context_t* _ctx) { /* (c : clock, prec : ? int) -> string */ 
  ...
  if (kk_std_core_types__is_Optional(_match_x77, _ctx)) {
    ...
    kk_integer_t _uniq_width_4546 = kk_integer_unbox(_box_x59, _ctx);
    kk_integer_dup(_uniq_width_4546, _ctx);
    kk_std_core_types__optional_drop(_match_x77, _ctx);
    _brw_x78 = _uniq_width_4546; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x77, _ctx);
  ...
  kk_std_core_types__optional _x_x346 = kk_std_core_types__new_Optional(kk_char_box(_b_x60_66, _ctx), _ctx); /*? 10003*/
  ...
  if (kk_std_core_types__is_Optional(_match_x73, _ctx)) {
    ...
    kk_integer_t _uniq_width_4546_0 = kk_integer_unbox(_box_x61, _ctx);
    kk_integer_dup(_uniq_width_4546_0, _ctx);
    kk_std_core_types__optional_drop(_match_x73, _ctx);
    _brw_x74 = _uniq_width_4546_0; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(_match_x73, _ctx);
  ...
  kk_std_core_types__optional _x_x354 = kk_std_core_types__new_Optional(kk_char_box(_b_x62_67, _ctx), _ctx); /*? 10003*/
  ...
  if (kk_std_core_types__is_Optional(prec, _ctx)) {
    ...
    kk_integer_t _uniq_prec_4745 = kk_integer_unbox(_box_x63, _ctx);
    kk_integer_dup(_uniq_prec_4745, _ctx);
    kk_std_core_types__optional_drop(prec, _ctx);
    _b_x64_68 = _uniq_prec_4745; /*int*/
  }
  else {
    kk_std_core_types__optional_drop(prec, _ctx);
  ...
  kk_std_core_types__optional _x_x361 = kk_std_core_types__new_Optional(kk_integer_box(_b_x64_68, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x362 = kk_std_core_types__new_Optional(kk_integer_box(_b_x65_69, _ctx), _ctx); /*? 10003*/
