...
kk_std_time_instant__timescale kk_std_time_instant_tai_timescale(kk_string_t name, kk_std_core_types__optional offset, kk_context_t* _ctx) { /* (name : string, offset : ? std/time/duration/duration) -> timescale */ 
  ...
  if (kk_std_core_types__is_Optional(offset, _ctx)) {
    ...
    _x_x321 = kk_double_box(_x_x322, _ctx); /*10003*/
    _x_x320 = kk_std_core_types__new_Optional(_x_x321, _ctx); /*? 10003*/
...
kk_std_time_instant__instant kk_std_time_instant_date_fs_instant(kk_std_time_instant__timescale ts, kk_integer_t days_0, kk_std_num_ddouble__ddouble secs, kk_std_core_types__optional leap, kk_context_t* _ctx) { /* (ts : timescale, days : int, secs : std/time/timestamp/timespan, leap : ? int) -> instant */ 
  ...
  kk_std_core_types__optional _x_x556 = kk_std_core_types__new_Optional(kk_std_num_ddouble__ddouble_box(secs, _ctx), _ctx); /*? 10003*/
  ...
  _x_x558 = kk_integer_box(_x_x559, _ctx); /*10003*/
  _x_x557 = kk_std_core_types__new_Optional(_x_x558, _ctx); /*? 10003*/
...
kk_string_t kk_std_time_instant_show_raw(kk_std_time_instant__instant i, kk_std_core_types__optional max_prec, kk_std_core_types__optional secs_width, kk_std_core_types__optional unit, kk_context_t* _ctx) { /* (i : instant, max-prec : ? int, secs-width : ? int, unit : ? string) -> string */ 
  ...
  kk_std_core_types__optional _x_x679 = kk_std_core_types__new_Optional(kk_integer_box(_b_x73_78, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x680 = kk_std_core_types__new_Optional(kk_integer_box(_b_x75_79, _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x681 = kk_std_core_types__new_Optional(kk_string_box(_b_x77_80), _ctx); /*? 10003*/
...
kk_string_t kk_std_time_instant_instant_fs_show(kk_std_time_instant__instant i, kk_std_core_types__optional max_prec, kk_std_core_types__optional secs_width, kk_context_t* _ctx) { /* (i : instant, max-prec : ? int, secs-width : ? int) -> string */ 
  ...
  _x_x721 = kk_integer_box(_x_x722, _ctx); /*10003*/
  _x_x720 = kk_std_core_types__new_Optional(_x_x721, _ctx); /*? 10003*/
  ...
  _x_x724 = kk_integer_box(_x_x725, _ctx); /*10003*/
  _x_x723 = kk_std_core_types__new_Optional(_x_x724, _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x726;
  kk_box_t _x_x727;
  kk_string_t _x_x728;
  kk_define_string_literal(, _s_x729, 1, "s", _ctx)
  _x_x728 = kk_string_dup(_s_x729, _ctx); /*string*/
  _x_x727 = kk_string_box(_x_x728); /*10003*/
  _x_x726 = kk_std_core_types__new_Optional(_x_x727, _ctx); /*? 10003*/
...
kk_std_core_types__tuple2 kk_std_time_instant_gps_week_timestamp(kk_std_time_instant__instant i, kk_context_t* _ctx) { /* (i : instant) -> (int, std/time/duration/duration) */ 
  ...
  _x_x766 = kk_double_box(_x_x767, _ctx); /*10003*/
  _x_x765 = kk_std_core_types__new_Optional(_x_x766, _ctx); /*? 10003*/
...
kk_std_time_instant__instant kk_std_time_instant_date_fs_gps_instant(kk_integer_t weeks, kk_std_time_duration__duration secs, kk_context_t* _ctx) { /* (weeks : int, secs : std/time/duration/duration) -> instant */ 
  ...
  _x_x770 = kk_double_box(_x_x771, _ctx); /*10003*/
  _x_x769 = kk_std_core_types__new_Optional(_x_x770, _ctx); /*? 10003*/
...
kk_string_t kk_std_time_instant_timestamp_fs_show(kk_std_time_timestamp__timestamp t, kk_std_core_types__optional max_prec, kk_std_core_types__optional secs_width, kk_std_core_types__optional unit, kk_context_t* _ctx) { /* (t : std/time/timestamp/timestamp, max-prec : ? int, secs-width : ? int, unit : ? string) -> string */ 
  ...
  _x_x804 = kk_integer_box(_x_x805, _ctx); /*10003*/
  ...
  _x_x807 = kk_integer_box(_x_x808, _ctx); /*10003*/
  _x_x806 = kk_std_core_types__new_Optional(_x_x807, _ctx); /*? 10003*/
  ...
  _x_x810 = kk_string_box(_x_x811); /*10003*/
  _x_x809 = kk_std_core_types__new_Optional(_x_x810, _ctx); /*? 10003*/
...
kk_std_time_instant__instant kk_std_time_instant_ddouble_fs_instant_at_mjd(kk_std_num_ddouble__ddouble mjd_0, kk_std_time_instant__timescale ts, kk_context_t* _ctx) { /* (mjd : std/num/ddouble/ddouble, ts : timescale) -> instant */ 
  ...
  kk_integer_t idays = kk_std_num_ddouble_int(days_0, kk_std_core_types__new_None(_ctx), _ctx); /*int*/;
  {
    ...
    if (kk_std_core_types__is_Nothing(_x_2, _ctx)) {
      ...
      kk_std_core_types__optional _x_x826 = kk_std_core_types__new_Optional(kk_std_num_ddouble__ddouble_box(secs_10175, _ctx), _ctx); /*? 10003*/
      ...
      _x_x828 = kk_integer_box(_x_x829, _ctx); /*10003*/
      _x_x827 = kk_std_core_types__new_Optional(_x_x828, _ctx); /*? 10003*/
...
void kk_std_time_instant__init(kk_context_t* _ctx){
  ...
  }
  {
    ...
    kk_std_core_types__optional _x_x736 = kk_std_core_types__new_Optional(kk_double_box(_b_x91_94, _ctx), _ctx); /*? 10003*/
    ...
    kk_std_core_types__optional _x_x739 = kk_std_core_types__new_Optional(kk_std_time_duration__duration_box(_b_x92_93, _ctx), _ctx); /*? 10003*/
  ...
  }
  {
    ...
    kk_std_core_types__optional _x_x741 = kk_std_core_types__new_Optional(kk_double_box(_b_x96_97, _ctx), _ctx); /*? 10003*/
  ...
  }
  {
    ...
    _x_x782 = kk_std_time_duration__duration_box(_x_x783, _ctx); /*10003*/
    _x_x781 = kk_std_core_types__new_Optional(_x_x782, _ctx); /*? 10003*/
  ...
  }
  {
    ...
    kk_std_core_types__optional _x_x786 = kk_std_core_types__new_Optional(kk_double_box(_b_x113_114, _ctx), _ctx); /*? 10003*/
