...
#include "whitemagic_dash_koka_src_unified__runtime__v3__main.h"
...
void kk_whitemagic_dash_koka_src_unified__runtime__v3__main__init(kk_context_t* _ctx){
  ...
  kk_whitemagic_dash_koka_src_unified__runtime__v3__init(_ctx);
...
void kk_whitemagic_dash_koka_src_unified__runtime__v3__main__done(kk_context_t* _ctx){
  ...
  kk_whitemagic_dash_koka_src_unified__runtime__v3__done(_ctx);
...
void main_init(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_unified__runtime__v3__main__init(_ctx);
}
void main_run(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_unified__runtime__v3__main__main(_ctx);
}
void main_done(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_unified__runtime__v3__main__done(_ctx);
}
