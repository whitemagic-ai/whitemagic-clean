...
static inline kk_std_num_decimal__decimal kk_std_num_decimal__mlift_parse_decimal_10268(kk_std_num_decimal__decimal x, kk_unit_t wild, kk_context_t* _ctx) { /* (x : decimal, wild : ()) -> std/text/parse/parse decimal */ 
  return x;
}
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_floor(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  kk_std_core_types__optional _x_x694 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x695 = kk_std_core_types__new_Optional(kk_std_num_decimal__round_box(kk_std_num_decimal__new_Floor(_ctx), _ctx), _ctx); /*? 10003*/
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_ceiling(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  kk_std_core_types__optional _x_x696 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x697 = kk_std_core_types__new_Optional(kk_std_num_decimal__round_box(kk_std_num_decimal__new_Ceiling(_ctx), _ctx), _ctx); /*? 10003*/
...
static inline kk_std_num_decimal__decimal kk_std_num_decimal_truncate(kk_std_num_decimal__decimal x, kk_context_t* _ctx) { /* (x : decimal) -> decimal */ 
  kk_std_core_types__optional _x_x698 = kk_std_core_types__new_Optional(kk_integer_box(kk_integer_from_small(0), _ctx), _ctx); /*? 10003*/
  kk_std_core_types__optional _x_x699 = kk_std_core_types__new_Optional(kk_std_num_decimal__round_box(kk_std_num_decimal__new_Truncate(_ctx), _ctx), _ctx); /*? 10003*/
