...
kk_hot__paths__path_profile kk_hot__paths_path_profile_fs__copy(kk_hot__paths__path_profile _this, kk_std_core_types__optional name, kk_std_core_types__optional call_count, kk_std_core_types__optional total_time_ms, kk_std_core_types__optional avg_time_ms, kk_std_core_types__optional complexity, kk_std_core_types__optional category, kk_context_t* _ctx) { /* (path-profile, name : ? string, call-count : ? int, total-time-ms : ? float64, avg-time-ms : ? float64, complexity : ? complexity, category : ? path-category) -> path-profile */ 
  ...
  if (kk_std_core_types__is_Optional(call_count, _ctx)) {
    ...
    kk_std_core_types__optional_drop(call_count, _ctx);
    {
      struct kk_hot__paths_Path_profile* _con_x115 = kk_hot__paths__as_Path_profile(_this, _ctx);
  ...
  if (kk_std_core_types__is_Optional(total_time_ms, _ctx)) {
    ...
    kk_std_core_types__optional_drop(total_time_ms, _ctx);
    {
      struct kk_hot__paths_Path_profile* _con_x117 = kk_hot__paths__as_Path_profile(_this, _ctx);
  ...
  if (kk_std_core_types__is_Optional(avg_time_ms, _ctx)) {
    ...
    kk_std_core_types__optional_drop(avg_time_ms, _ctx);
    {
      struct kk_hot__paths_Path_profile* _con_x119 = kk_hot__paths__as_Path_profile(_this, _ctx);
      double _x_2 = _con_x119->avg_time_ms;
      _x_x118 = _x_2; /*float64*/
    }
  }
  kk_hot__paths__complexity _x_x120;
  if (kk_std_core_types__is_Optional(complexity, _ctx)) {
    ...
    _x_x120 = _uniq_complexity_194; /*hot_paths/complexity*/
  }
  else {
    kk_std_core_types__optional_drop(complexity, _ctx);
    {
      struct kk_hot__paths_Path_profile* _con_x121 = kk_hot__paths__as_Path_profile(_this, _ctx);
      kk_hot__paths__complexity _x_3 = _con_x121->complexity;
      _x_x120 = _x_3; /*hot_paths/complexity*/
    }
  }
  kk_hot__paths__path_category _x_x122;
  if (kk_std_core_types__is_Optional(category, _ctx)) {
    ...
    _x_x122 = _uniq_category_202; /*hot_paths/path-category*/
  }
  else {
    kk_std_core_types__optional_drop(category, _ctx);
    {
      struct kk_hot__paths_Path_profile* _con_x123 = kk_hot__paths__as_Path_profile(_this, _ctx);
      kk_string_t _pat_0_5 = _con_x123->name;
      kk_integer_t _pat_1_6 = _con_x123->call_count;
      kk_hot__paths__path_category _x_4 = _con_x123->category;
      ...
      _x_x122 = _x_4; /*hot_paths/path-category*/
    }
  }
  return kk_hot__paths__new_Path_profile(kk_reuse_null, 0, _x_x112, _x_x114, _x_x116, _x_x118, _x_x120, _x_x122, _ctx);
}
...
kk_hot__paths__profiling_session kk_hot__paths_profiling_session_fs__copy(kk_hot__paths__profiling_session _this, kk_std_core_types__optional paths, kk_std_core_types__optional total_calls, kk_std_core_types__optional total_time_ms, kk_std_core_types__optional hot_threshold_ms, kk_context_t* _ctx) { /* (profiling-session, paths : ? (list<path-profile>), total-calls : ? int, total-time-ms : ? float64, hot-threshold-ms : ? float64) -> profiling-session */ 
  ...
  if (kk_std_core_types__is_Optional(paths, _ctx)) {
    ...
    _x_x128 = _uniq_paths_255; /*list<hot_paths/path-profile>*/
  }
  else {
    kk_std_core_types__optional_drop(paths, _ctx);
    {
      struct kk_hot__paths_Profiling_session* _con_x129 = kk_hot__paths__as_Profiling_session(_this, _ctx);
      kk_std_core_types__list _x = _con_x129->paths;
      kk_std_core_types__list_dup(_x, _ctx);
      _x_x128 = _x; /*list<hot_paths/path-profile>*/
    }
  }
  ...
  if (kk_std_core_types__is_Optional(total_calls, _ctx)) {
    ...
    kk_std_core_types__optional_drop(total_calls, _ctx);
    {
      struct kk_hot__paths_Profiling_session* _con_x131 = kk_hot__paths__as_Profiling_session(_this, _ctx);
  ...
  if (kk_std_core_types__is_Optional(total_time_ms, _ctx)) {
    ...
    kk_std_core_types__optional_drop(total_time_ms, _ctx);
    {
      struct kk_hot__paths_Profiling_session* _con_x133 = kk_hot__paths__as_Profiling_session(_this, _ctx);
  ...
  if (kk_std_core_types__is_Optional(hot_threshold_ms, _ctx)) {
    ...
    kk_std_core_types__optional_drop(hot_threshold_ms, _ctx);
    {
      struct kk_hot__paths_Profiling_session* _con_x135 = kk_hot__paths__as_Profiling_session(_this, _ctx);
  ...
  return kk_hot__paths__new_Profiling_session(kk_reuse_null, 0, _x_x128, _x_x130, _x_x132, _x_x134, _ctx);
}
...
kk_string_t kk_hot__paths_json_profile(kk_hot__paths__path_profile p, kk_context_t* _ctx) { /* (p : path-profile) -> string */ 
  ...
  kk_string_t _x_x175;
  {
    struct kk_hot__paths_Path_profile* _con_x176 = kk_hot__paths__as_Path_profile(p, _ctx);
  ...
  {
    struct kk_hot__paths_Path_profile* _con_x183 = kk_hot__paths__as_Path_profile(p, _ctx);
  ...
  double _x_x189;
  {
    struct kk_hot__paths_Path_profile* _con_x190 = kk_hot__paths__as_Path_profile(p, _ctx);
  ...
  kk_string_t _x_x195;
  {
    struct kk_hot__paths_Path_profile* _con_x196 = kk_hot__paths__as_Path_profile(p, _ctx);
    kk_hot__paths__complexity _x_2 = _con_x196->complexity;
  ...
  kk_string_t _x_x208;
  {
    struct kk_hot__paths_Path_profile* _con_x209 = kk_hot__paths__as_Path_profile(p, _ctx);
    kk_string_t _pat_0_5 = _con_x209->name;
    kk_integer_t _pat_1_5 = _con_x209->call_count;
    kk_hot__paths__path_category _x_3 = _con_x209->category;
...
kk_unit_t kk_hot__paths__mlift_server_loop_10034(kk_string_t op, kk_std_core_types__list profiles, kk_integer_t total_calls, double total_time, kk_string_t _c_x10018, kk_context_t* _ctx) { /* (op : string, profiles : list<path-profile>, total-calls : int, total-time : float64, string) -> () */ 
  ...
  if (_match_x74) {
    ...
    kk_hot__paths_server_loop(_x_x255, _x_x256, profiles, _ctx); return kk_Unit;
  }
  {
...
struct kk_hot__paths__mlift_server_loop_10035_fun261__t {
  struct kk_function_s _base;
};
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun261(kk_function_t _fself, kk_box_t _b_x12, kk_context_t* _ctx);
static kk_function_t kk_hot__paths__new_mlift_server_loop_10035_fun261(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_hot__paths__mlift_server_loop_10035_fun261, _ctx)
...
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun261(kk_function_t _fself, kk_box_t _b_x12, kk_context_t* _ctx) {
  ...
  _x_x262 = kk_hot__paths_extract_op(_x_x263, _ctx); /*string*/
  return kk_string_box(_x_x262);
}


// lift anonymous function
struct kk_hot__paths__mlift_server_loop_10035_fun268__t {
  struct kk_function_s _base;
};
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun268(kk_function_t _fself, kk_box_t _b_x17, kk_context_t* _ctx);
static kk_function_t kk_hot__paths__new_mlift_server_loop_10035_fun268(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_hot__paths__mlift_server_loop_10035_fun268, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}
...
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun268(kk_function_t _fself, kk_box_t _b_x17, kk_context_t* _ctx) {
  ...
  _x_x269 = kk_hot__paths_extract_name(_x_x270, _ctx); /*string*/
  return kk_string_box(_x_x269);
}


// lift anonymous function
struct kk_hot__paths__mlift_server_loop_10035_fun277__t {
  struct kk_function_s _base;
};
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun277(kk_function_t _fself, kk_box_t _b_x22, kk_context_t* _ctx);
static kk_function_t kk_hot__paths__new_mlift_server_loop_10035_fun277(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_hot__paths__mlift_server_loop_10035_fun277, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}
...
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun277(kk_function_t _fself, kk_box_t _b_x22, kk_context_t* _ctx) {
  ...
  _x_x278 = kk_hot__paths_extract_name(_x_x279, _ctx); /*string*/
  return kk_string_box(_x_x278);
}


// lift anonymous function
struct kk_hot__paths__mlift_server_loop_10035_fun297__t {
  struct kk_function_s _base;
};
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun297(kk_function_t _fself, kk_box_t _b_x28, kk_box_t _b_x29, kk_context_t* _ctx);
static kk_function_t kk_hot__paths__new_mlift_server_loop_10035_fun297(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_hot__paths__mlift_server_loop_10035_fun297, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}
...
// lift anonymous function
struct kk_hot__paths__mlift_server_loop_10035_fun306__t {
  struct kk_function_s _base;
  kk_string_t op_0;
...
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun306(kk_function_t _fself, kk_box_t _b_x34, kk_context_t* _ctx);
static kk_function_t kk_hot__paths__new_mlift_server_loop_10035_fun306(kk_string_t op_0, kk_std_core_types__list profiles_0, kk_integer_t total_calls_0, double total_time_0, kk_context_t* _ctx) {
  struct kk_hot__paths__mlift_server_loop_10035_fun306__t* _self = kk_function_alloc_as(struct kk_hot__paths__mlift_server_loop_10035_fun306__t, 4, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_hot__paths__mlift_server_loop_10035_fun306, kk_context());
  _self->op_0 = op_0;
...
static kk_box_t kk_hot__paths__mlift_server_loop_10035_fun306(kk_function_t _fself, kk_box_t _b_x34, kk_context_t* _ctx) {
  struct kk_hot__paths__mlift_server_loop_10035_fun306__t* _self = kk_function_as(struct kk_hot__paths__mlift_server_loop_10035_fun306__t*, _fself, _ctx);
  ...
  kk_hot__paths__mlift_server_loop_10034(op_0, profiles_0, total_calls_0, total_time_0, _c_x10018_0_36, _ctx);
...
kk_unit_t kk_hot__paths__mlift_server_loop_10035(kk_std_core_types__list profiles_0, kk_integer_t total_calls_0, double total_time_0, kk_string_t line, kk_context_t* _ctx) { /* (profiles : list<path-profile>, total-calls : int, total-time : float64, line : string) -> <console/console,exn> () */ 
  ...
  if (_match_x72) {
    ...
    _x_x264 = kk_string_box(_x_x265); /*9903*/
    _x_x260 = kk_std_core_hnd__open_none1(kk_hot__paths__new_mlift_server_loop_10035_fun261(_ctx), _x_x264, _ctx); /*9904*/
    op_0 = kk_string_unbox(_x_x260); /*string*/
    kk_string_t x_10036;
    if (kk_string_cmp_cstr_borrow(op_0, "record", _ctx) == 0) {
      kk_string_t name;
      kk_box_t _x_x267 = kk_std_core_hnd__open_none1(kk_hot__paths__new_mlift_server_loop_10035_fun268(_ctx), kk_string_box(line), _ctx); /*9904*/
    ...
    if (kk_string_cmp_cstr_borrow(op_0, "profile", _ctx) == 0) {
      kk_string_t name_0;
      kk_box_t _x_x276 = kk_std_core_hnd__open_none1(kk_hot__paths__new_mlift_server_loop_10035_fun277(_ctx), kk_string_box(line), _ctx); /*9904*/
    ...
    if (kk_string_cmp_cstr_borrow(op_0, "status", _ctx) == 0) {
      ...
      kk_string_t _x_x294;
      kk_string_t _x_x295;
      kk_box_t _x_x296 = kk_std_core_hnd__open_none2(kk_hot__paths__new_mlift_server_loop_10035_fun297(_ctx), kk_double_box(total_time_0, _ctx), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*9985*/
    ...
    if (kk_yielding(kk_context())) {
      ...
      kk_box_t _x_x305 = kk_std_core_hnd_yield_extend(kk_hot__paths__new_mlift_server_loop_10035_fun306(op_0, profiles_0, total_calls_0, total_time_0, _ctx), _ctx); /*2419*/
      kk_unit_unbox(_x_x305); return kk_Unit;
    }
    {
      kk_hot__paths__mlift_server_loop_10034(op_0, profiles_0, total_calls_0, total_time_0, x_10036, _ctx); return kk_Unit;
    }
  }
  {
...
// lift anonymous function
struct kk_hot__paths_server_loop_fun309__t {
  struct kk_function_s _base;
  kk_std_core_types__list profiles_1;
  kk_integer_t total_calls_1;
  double total_time_1;
};
static kk_box_t kk_hot__paths_server_loop_fun309(kk_function_t _fself, kk_box_t _b_x38, kk_context_t* _ctx);
static kk_function_t kk_hot__paths_new_server_loop_fun309(kk_std_core_types__list profiles_1, kk_integer_t total_calls_1, double total_time_1, kk_context_t* _ctx) {
  struct kk_hot__paths_server_loop_fun309__t* _self = kk_function_alloc_as(struct kk_hot__paths_server_loop_fun309__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_hot__paths_server_loop_fun309, kk_context());
...
static kk_box_t kk_hot__paths_server_loop_fun309(kk_function_t _fself, kk_box_t _b_x38, kk_context_t* _ctx) {
  struct kk_hot__paths_server_loop_fun309__t* _self = kk_function_as(struct kk_hot__paths_server_loop_fun309__t*, _fself, _ctx);
  ...
  kk_hot__paths__mlift_server_loop_10035(profiles_1, total_calls_1, total_time_1, line_0_66, _ctx);
...
static kk_box_t kk_hot__paths_server_loop_fun315(kk_function_t _fself, kk_box_t _b_x41, kk_context_t* _ctx);
...
static kk_box_t kk_hot__paths_server_loop_fun315(kk_function_t _fself, kk_box_t _b_x41, kk_context_t* _ctx) {
  ...
  _x_x316 = kk_hot__paths_extract_op(_x_x317, _ctx); /*string*/
  return kk_string_box(_x_x316);
}


// lift anonymous function
struct kk_hot__paths_server_loop_fun322__t {
  struct kk_function_s _base;
};
static kk_box_t kk_hot__paths_server_loop_fun322(kk_function_t _fself, kk_box_t _b_x46, kk_context_t* _ctx);
static kk_function_t kk_hot__paths_new_server_loop_fun322(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_hot__paths_server_loop_fun322, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}
...
static kk_box_t kk_hot__paths_server_loop_fun322(kk_function_t _fself, kk_box_t _b_x46, kk_context_t* _ctx) {
  ...
  _x_x323 = kk_hot__paths_extract_name(_x_x324, _ctx); /*string*/
  return kk_string_box(_x_x323);
}


// lift anonymous function
struct kk_hot__paths_server_loop_fun331__t {
  struct kk_function_s _base;
};
static kk_box_t kk_hot__paths_server_loop_fun331(kk_function_t _fself, kk_box_t _b_x51, kk_context_t* _ctx);
static kk_function_t kk_hot__paths_new_server_loop_fun331(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_hot__paths_server_loop_fun331, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}
...
static kk_box_t kk_hot__paths_server_loop_fun331(kk_function_t _fself, kk_box_t _b_x51, kk_context_t* _ctx) {
  ...
  _x_x332 = kk_hot__paths_extract_name(_x_x333, _ctx); /*string*/
  return kk_string_box(_x_x332);
}


// lift anonymous function
struct kk_hot__paths_server_loop_fun351__t {
  struct kk_function_s _base;
};
static kk_box_t kk_hot__paths_server_loop_fun351(kk_function_t _fself, kk_box_t _b_x57, kk_box_t _b_x58, kk_context_t* _ctx);
static kk_function_t kk_hot__paths_new_server_loop_fun351(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_hot__paths_server_loop_fun351, _ctx)
  return kk_function_static_dup(_fself,kk_context());
}
...
// lift anonymous function
struct kk_hot__paths_server_loop_fun360__t {
  struct kk_function_s _base;
  kk_string_t op_1;
  kk_std_core_types__list profiles_1;
  kk_integer_t total_calls_1;
...
static kk_box_t kk_hot__paths_server_loop_fun360(kk_function_t _fself, kk_box_t _b_x63, kk_context_t* _ctx);
static kk_function_t kk_hot__paths_new_server_loop_fun360(kk_string_t op_1, kk_std_core_types__list profiles_1, kk_integer_t total_calls_1, double total_time_1, kk_context_t* _ctx) {
  struct kk_hot__paths_server_loop_fun360__t* _self = kk_function_alloc_as(struct kk_hot__paths_server_loop_fun360__t, 4, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_hot__paths_server_loop_fun360, kk_context());
  _self->op_1 = op_1;
  _self->profiles_1 = profiles_1;
  _self->total_calls_1 = total_calls_1;
  _self->total_time_1 = total_time_1;
...
static kk_box_t kk_hot__paths_server_loop_fun360(kk_function_t _fself, kk_box_t _b_x63, kk_context_t* _ctx) {
  struct kk_hot__paths_server_loop_fun360__t* _self = kk_function_as(struct kk_hot__paths_server_loop_fun360__t*, _fself, _ctx);
  ...
  kk_hot__paths__mlift_server_loop_10034(op_1, profiles_1, total_calls_1, total_time_1, _c_x10018_1_67, _ctx);
...
kk_unit_t kk_hot__paths_server_loop(kk_integer_t total_calls_1, double total_time_1, kk_std_core_types__list profiles_1, kk_context_t* _ctx) { /* (total-calls : int, total-time : float64, profiles : list<path-profile>) -> io () */ 
  ...
  if (kk_yielding(kk_context())) {
    ...
    kk_box_t _x_x308 = kk_std_core_hnd_yield_extend(kk_hot__paths_new_server_loop_fun309(profiles_1, total_calls_1, total_time_1, _ctx), _ctx); /*2419*/
  ...
  }
  {
    ...
    if (_match_x69) {
      ...
      _x_x318 = kk_string_box(_x_x319); /*9903*/
      _x_x314 = kk_std_core_hnd__open_none1(kk_hot__paths_new_server_loop_fun315(_ctx), _x_x318, _ctx); /*9904*/
      op_1 = kk_string_unbox(_x_x314); /*string*/
      kk_string_t x_1_10041;
      if (kk_string_cmp_cstr_borrow(op_1, "record", _ctx) == 0) {
        kk_string_t name_1;
        kk_box_t _x_x321 = kk_std_core_hnd__open_none1(kk_hot__paths_new_server_loop_fun322(_ctx), kk_string_box(x_0_10038), _ctx); /*9904*/
      ...
      if (kk_string_cmp_cstr_borrow(op_1, "profile", _ctx) == 0) {
        ...
        kk_box_t _x_x330 = kk_std_core_hnd__open_none1(kk_hot__paths_new_server_loop_fun331(_ctx), kk_string_box(x_0_10038), _ctx); /*9904*/
      ...
      if (kk_string_cmp_cstr_borrow(op_1, "status", _ctx) == 0) {
        ...
        kk_string_t _x_x348;
        kk_string_t _x_x349;
        kk_box_t _x_x350 = kk_std_core_hnd__open_none2(kk_hot__paths_new_server_loop_fun351(_ctx), kk_double_box(total_time_1, _ctx), kk_std_core_types__optional_box(kk_std_core_types__new_None(_ctx), _ctx), _ctx); /*9985*/
      ...
      if (kk_yielding(kk_context())) {
        ...
        kk_box_t _x_x359 = kk_std_core_hnd_yield_extend(kk_hot__paths_new_server_loop_fun360(op_1, profiles_1, total_calls_1, total_time_1, _ctx), _ctx); /*2419*/
