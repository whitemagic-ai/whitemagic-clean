...
#include "whitemagic_dash_koka_src_gan__ying__main.h"
...
void kk_whitemagic_dash_koka_src_gan__ying__main__init(kk_context_t* _ctx){
  ...
  kk_whitemagic_dash_koka_src_gan__ying__init(_ctx);
...
void kk_whitemagic_dash_koka_src_gan__ying__main__done(kk_context_t* _ctx){
  ...
  kk_whitemagic_dash_koka_src_gan__ying__done(_ctx);
...
void main_init(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_gan__ying__main__init(_ctx);
}
void main_run(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_gan__ying__main__main(_ctx);
}
void main_done(kk_context_t* _ctx) {
  kk_whitemagic_dash_koka_src_gan__ying__main__done(_ctx);
}
