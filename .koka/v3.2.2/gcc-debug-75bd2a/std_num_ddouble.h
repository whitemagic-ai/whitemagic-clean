...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble__mlift_parse_ddouble_10806(kk_std_num_ddouble__ddouble x, kk_unit_t wild, kk_context_t* _ctx) { /* (x : ddouble, wild : ()) -> std/text/parse/parse ddouble */ 
  return x;
}
...
static inline kk_std_core_types__tuple2 kk_std_num_ddouble_decode(kk_std_num_ddouble__ddouble d, kk_context_t* _ctx) { /* (d : ddouble) -> (float64, float64) */ 
  ...
  _x_x1284 = kk_double_box(_x_x1285, _ctx); /*10037*/
  kk_box_t _x_x1286;
  double _x_x1287;
  {
    double _x_0 = d.lo;
  ...
  _x_x1286 = kk_double_box(_x_x1287, _ctx); /*10038*/
...
static inline kk_std_num_ddouble__ddouble kk_std_num_ddouble_sin16(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> ddouble */ 
  ...
  kk_std_core_types__maybe _brw_x564 = kk_std_core_vector_at(kk_std_num_ddouble_sin16_table, i, _ctx); /*maybe<10000>*/;
