...
ToolDefinition(
    ...
    input_schema={
        "type": "object",
        "properties": {
            "command": {"type": "string", "description": "Command to validate", "default": "ls"},
        },
    },
),
ToolDefinition(
    ...
    input_schema={
        "type": "object",
        "properties": {
            "goal": {"type": "string", "description": "Current goal", "default": "System safety"},
        },
    },
),
ToolDefinition(
    ...
    input_schema={
        "type": "object",
        "properties": {
            "action": {"type": "string", "description": "Action to check", "default": "read"},
