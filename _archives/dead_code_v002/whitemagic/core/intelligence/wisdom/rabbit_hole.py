...
class RabbitHoleExplorer:
    ...
    def __init__(self, max_parallel: int = 64, max_depth: int = 3):
...
"""
    ...
    def create_report(
        ...
        connections = self.find_connections(entries)  # type: ignore[arg-type]
        synthesis = self.generate_synthesis(entries, connections)  # type: ignore[arg-type]
