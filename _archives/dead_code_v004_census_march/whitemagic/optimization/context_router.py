...
class ContextRouter:
    ...
    def _check_rust_available(self) -> bool:
        ...
        return importlib.util.find_spec("whitemagic_rs") is not None
    
    def _check_elixir_available(self) -> bool:
    ...
    def _check_julia_available(self) -> bool:
    ...
    def _check_haskell_available(self) -> bool:
