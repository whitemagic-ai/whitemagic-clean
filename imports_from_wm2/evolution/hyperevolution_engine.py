...
try:
    from whitemagic_rs import tokio_clones, parallel_fitness_batch
    RUST_AVAILABLE = True
except ImportError:
...
try:
    ...
    from whitemagic.core.intelligence.synthesis.kaizen_engine import KaizenEngine, ImprovementProposal
