"""
WM2 Migration: whitemagic/core/memory/graph_engine.py
=====================================================
...
class GraphEngine(BaseEngine, Serializable, MetricCollector):
    """Migrated graph_engine using WM2 unified patterns."""
    
    def __init__(self, name: str = "graph_engine"):
