...
from whitemagic.tools.unified_api import call_tool  # type: ignore[import-not-found]
    ...
    def save_report(self, filepath: Path):
        ...
        report = {
            ...
            "patterns": {
                ...
                "very_slow_tools": [
                    {"gana": g, "tool": t, "latency_ms": latency}
                    for g, t, latency in self.patterns["very_slow_tools"]
                ],
