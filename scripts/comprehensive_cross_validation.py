...
print(f"\n{'='*80}")
print(f"TOP PATTERNS (≥0.77 CONFIDENCE - AUTO-APPLY READY)")
print(f"{'='*80}")
...
if ultra_high:
    ...
    print(f"   Need more cross-validation sources")

print(f"\n{'='*80}")
print(f"HIGH-CONFIDENCE PATTERNS (0.60-0.77 - MANUAL REVIEW)")
print(f"{'='*80}")
