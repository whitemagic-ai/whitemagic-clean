...
def generate_markdown_report(results, output_path):
    """Generate markdown report."""
    lines = [
        "# Focused LLM Enhancement Benchmark",
        "",
    ...
    lines.extend([
        "## Key Findings",
        "",
        "1. **Memory Grounding (RAG)**: Provides context from 107K memories",
        "2. **Chain-of-Thought**: Forces explicit reasoning steps",
        "3. **Full-Stack**: Combines all enhancements for maximum quality",
        "",
        "WhiteMagic's meta-harness transforms a small local LLM into a much more capable system.",
        "",
        "---",
        "",
