...
def main():
    ...
    # Instead of running mix run --no-start, let's run the mix project properly to ensure NIFs are loaded
    ...
    try:
        ...
        while not BLACKBOARD["completed"] and time.time() - start_time < 120:
            time.sleep(1)
