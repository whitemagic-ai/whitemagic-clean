...
def benchmark_database_backends():
    ...
    from whitemagic.core.storage.polyglot_db import BackendType, get_polyglot_db
...
def benchmark_tool_discovery():
    ...
    from whitemagic.tools.integrated_api import autocast, discover_tools, tool_stats
