...
try:
    ...
    print(f"✅ Edge Inference validated")
...
try:
    ...
    if rust_available():
        ...
        print(f"✅ Association mining validated")
        print(f"   Clones deployed: {clone_count:,}")
        print(f"   Avg latency: {avg_latency:.4f}ms")
...
try:
    ...
    print(f"✅ Spatial queries validated")
    print(f"   Clones deployed: {clone_count:,}")
    print(f"   Avg latency: {avg_latency:.4f}ms")
    print(f"   Results per query: {len(results_5d)}")
    print(f"   Backend: Rust SpatialIndex5D")
...
try:
    ...
    print(f"✅ Context router validated")
    print(f"   Clones deployed: {clone_count:,}")
